onEvent("recipes", (event) => {
    event
        .shaped(Item.of("sophisticatedbackpacks:recycler_upgrade"), ["XOX", "BUB", "XPX"], {
    ...
    event
        .shaped(
            Item.of("sophisticatedbackpacks:recycler_upgrade_advanced"),
            ["XOX", "BUB", "XPX"],
            {
                X: "the_vault:vault_diamond_block",
    ...
    event
        .shaped(Item.of("sophisticatedbackpacks:diffuser_upgrade"), ["XOX", "BUB", "XPX"], {
            X: "the_vault:vault_diamond_block",
    ...
    event
        .shaped(
            Item.of("sophisticatedbackpacks:diffuser_upgrade_advanced"),
            ["XOX", "BUB", "XPX"],
            {
    ...
    event
        .shaped(Item.of("sophisticatedbackpacks:activator_upgrade"), ["XOX", "BUB", "XPX"], {
    ...
    event
        .shaped(Item.of("sophisticatedstorage:recycler_upgrade"), ["XOX", "BUB", "XPX"], {
            X: "the_vault:magic_silk_block",
            O: "woldsvaults:vault_salvager",
