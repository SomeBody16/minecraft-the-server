let removedOutputsF = ["farmingforblockheads:market"];
onEvent("recipes", (event) => {
    ...
    event.shaped(Item.of("farmingforblockheads:market"), ["POP", "L L", "LLL"], {
        P: "the_vault:driftwood",
        O: "the_vault:extraordinary_painite",
        L: "the_vault:driftwood_planks",
    });

    event.shaped(Item.of("farmingforblockheads:red_fertilizer"), ["RRR", "COC", "LLL"], {
        R: "minecraft:red_dye",
    ...
    event.shaped(Item.of("farmingforblockheads:yellow_fertilizer"), ["YYY", "COC", "LLL"], {
    ...
    event.shaped(Item.of("farmingforblockheads:green_fertilizer"), ["GGG", "COC", "LLL"], {
