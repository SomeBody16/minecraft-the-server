...
onEvent("recipes", (event) => {
    ...
    event.shaped(Item.of("botanicalmachinery:alfheim_market"), ["IWI", "GTG", "IXI"], {
    ...
    event.shaped(
        Item.of("botanicalmachinery:industrial_agglomeration_factory"),
        ["IWI", "YTG", "IXI"],
        {
            I: "botania:elementium_ingot",
    ...
    event.shaped(Item.of("botanicalmachinery:mana_battery"), ["IWI", "WTW", "IXI"], {
    ...
    event.shaped(Item.of("botanicalmachinery:mechanical_apothecary"), ["IWI", "WTW", "IXI"], {
        I: "botania:elementium_ingot",
        W: "#botania:petals",
        T: "the_vault:vault_diamond_block",
    ...
    event.shaped(Item.of("botanicalmachinery:mechanical_brewery"), ["IRI", "WTW", "IXI"], {
        I: "botania:elementium_ingot",
        W: "botania:flask",
    ...
    event.shaped(Item.of("botanicalmachinery:mechanical_daisy"), [" T ", "IXI"], {
        I: "botania:elementium_block",
        T: "botania:floating_pure_daisy",
        X: "the_vault:vault_diamond_block",
    });

    event.shaped(Item.of("botanicalmachinery:mechanical_mana_pool"), ["IWI", "YTG", "IXI"], {
        I: "botania:elementium_ingot",
    ...
    event.shaped(Item.of("botanicalmachinery:mechanical_runic_altar"), ["IWI", "WTW", "IXI"], {
        I: "botania:elementium_ingot",
        W: "#botania:runes",
        T: "the_vault:vault_diamond_block",
