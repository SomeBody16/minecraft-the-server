...
onEvent("recipes", (event) => {
    ...
    event.shaped(Item.of("pneumaticcraft:spawner_core_shell"), ["IGI", "GEG", "IGI"], {
        I: "pneumaticcraft:ingot_iron_compressed",
        G: "pneumaticcraft:pressure_chamber_glass",
        E: "the_vault:perfect_black_opal",
    });

    event.shaped(Item.of("pneumaticcraft:gps_tool"), [" G ", "PEP", "PDP"], {
    ...
    event.shaped(Item.of("pneumaticcraft:memory_stick"), ["DGD", "PEP", "I I"], {
        P: "pneumaticcraft:plastic",
    ...
    event.shaped(Item.of("pneumaticcraft:vortex_cannon"), ["IDI", "C  ", "ILI"], {
        I: "pneumaticcraft:ingot_iron_compressed",
        D: "the_vault:gem_pog",
    ...
    event.shaped(Item.of("pneumaticcraft:minigun"), ["C  ", "DIH", "GL "], {
        I: "pneumaticcraft:ingot_iron_compressed",
        D: "the_vault:gem_pog",
        C: "pneumaticcraft:air_canister",
        L: "minecraft:lever",
    ...
    event.shaped(Item.of("pneumaticcraft:jackhammer"), ["PBP", "ITI", "DWD"], {
        I: "pneumaticcraft:ingot_iron_compressed",
    ...
    event.shaped(Item.of("pneumaticcraft:amadron_tablet"), ["GXG", "PEP", "PDP"], {
        P: "pneumaticcraft:plastic",
        G: "the_vault:black_chromatic_steel_ingot",
    ...
    event.shaped(Item.of("pneumaticcraft:drone"), ["BTB", "TPT", "XTX"], {
    ...
    event.shaped(Item.of("8x pneumaticcraft:pressure_tube"), ["TPT"], {
        P: "the_vault:perfect_larimar",
        T: "pneumaticcraft:ingot_iron_compressed",
    });

    event.shaped(Item.of("pneumaticcraft:spawner_extractor"), ["ITI", "WPW", "BDB"], {
        I: "pneumaticcraft:ingot_iron_compressed",
        T: "pneumaticcraft:pressure_tube",
    ...
    event.shaped(Item.of("pneumaticcraft:small_tank"), ["BTB", "TPT", "BTB"], {
        B: "the_vault:gem_larimar",
        T: "pneumaticcraft:ingot_iron_compressed",
        P: "#forge:glass",
    });

    event.shaped(Item.of("pneumaticcraft:medium_tank"), ["BDB", "TPT", "BDB"], {
    ...
    event.shaped(Item.of("pneumaticcraft:large_tank"), ["BDB", "TPT", "BDB"], {
        B: "pneumaticcraft:plastic",
    ...
    event.shaped(Item.of("pneumaticcraft:refinery_output"), ["BBB", "TPT", "BBB"], {
        B: "pneumaticcraft:ingot_iron_compressed",
        T: "#forge:glass",
        P: "the_vault:vault_diamond",
    });

    event.shaped(Item.of("pneumaticcraft:refinery"), ["BBB", "TPT", "BBB"], {
        B: "pneumaticcraft:reinforced_stone_slab",
        T: "the_vault:perfect_larimar",
        P: "pneumaticcraft:small_tank",
    });

    event.shaped(Item.of("pneumaticcraft:aerial_interface"), ["WHW", "PSP", "WTW"], {
        W: "pneumaticcraft:pressure_chamber_wall",
    ...
    event.shaped(Item.of("pneumaticcraft:pressure_chamber_wall"), ["SBS", "S S", "SBS"], {
        S: "pneumaticcraft:reinforced_bricks",
        B: "the_vault:gem_black_opal",
    });

    event.shaped(Item.of("pneumaticcraft:reinforced_stone", 8), ["SSS", "SIS", "SSS"], {
        S: "the_vault:vault_stone",
        I: "pneumaticcraft:ingot_iron_compressed",
    });

    event.shaped(Item.of("pneumaticcraft:crop_support"), ["L L", "S S", "S S"], {
        S: "pneumaticcraft:ingot_iron_compressed",
        L: "the_vault:perfect_larimar",
    });

    event.shaped(Item.of("pneumaticcraft:air_canister"), [" T ", "SRS", "SRS"], {
        S: "pneumaticcraft:ingot_iron_compressed",
        T: "pneumaticcraft:pressure_tube",
        R: "the_vault:perfect_larimar",
    });

    event.shapeless("pneumaticcraft:unassembled_netherite_drill_bit", [
        "pneumaticcraft:drill_bit_diamond",
        "the_vault:echoing_ingot",
    ]);
    event.shapeless("9x pneumaticcraft:ingot_iron_compressed", [
