onEvent("recipes", (event) => {
    event
        .shaped(Item.of("immersiveengineering:cokebrick", 3), ["XLX", "TBT", "XLX"], {
    ...
    event
        .shaped(Item.of("immersiveengineering:blastbrick", 3), ["XLX", "TBT", "XLX"], {
    ...
    event
        .shaped(Item.of("immersiveengineering:craftingtable", 1), ["XXX", "TBT", "T T"], {
    ...
    event
        .shaped(Item.of("immersiveengineering:workbench", 1), ["   ", "ISS", "T F"], {
    ...
    event
        .shaped(Item.of("immersiveengineering:turntable", 1), ["   ", "SXS", "TCT"], {
    ...
    event
        .shaped(Item.of("immersiveengineering:crate", 1), ["WWW", "WLW", "WWW"], {
    ...
    event
        .shaped(Item.of("immersiveengineering:sorter", 1), ["WRW", "ILI", "WCW"], {
            W: "#forge:treated_wood",
    ...
    event
        .shaped(Item.of("immersiveengineering:item_batcher", 1), ["WRW", "ILI", "WCW"], {
            W: "#forge:treated_wood",
            L: "immersiveengineering:component_iron",
            I: "the_vault:chromatic_steel_ingot",
    ...
    event
        .shaped(Item.of("immersiveengineering:fluid_sorter", 1), ["WRW", "ILI", "WCW"], {
            W: "#forge:treated_wood",
            L: "immersiveengineering:component_iron",
            I: "the_vault:chromatic_steel_ingot",
    ...
    event
        .shaped(Item.of("immersiveengineering:windmill", 1), ["WWW", "WLW", "WWW"], {
    ...
    event
        .shaped(Item.of("immersiveengineering:watermill", 1), ["IWI", "WLW", "IWI"], {
            W: "immersiveengineering:windmill_blade",
    ...
    event
        .shaped(Item.of("immersiveengineering:capacitor_lv", 1), ["WPW", "ILI", "WPW"], {
            W: "#forge:treated_wood",
    ...
    event
        .shaped(Item.of("immersiveengineering:capacitor_hv", 1), ["WpW", "ILI", "WPW"], {
            W: "#forge:treated_wood",
            L: "immersiveengineering:redstone_acid_bucket",
    ...
    event
        .shaped(Item.of("immersiveengineering:fluid_placer", 1), ["XTX", "TBT", "XTX"], {
            X: "#forge:plates/iron",
    ...
    event
        .shaped(Item.of("immersiveengineering:component_iron", 1), ["XTX", "TBT", "XTX"], {
            X: "#forge:plates/iron",
    ...
    event
        .shaped(Item.of("immersiveengineering:component_steel", 1), ["XTX", "TBT", "XTX"], {
    ...
    event
        .shaped(Item.of("immersiveengineering:light_engineering", 4), ["XTX", "TBT", "XTX"], {
    ...
    event
        .shaped(Item.of("immersiveengineering:heavy_engineering", 4), ["XTX", "TBT", "XTX"], {
    ...
    event
        .shaped(Item.of("immersiveengineering:rs_engineering", 4), ["XTX", "TBT", "XTX"], {
            X: "immersiveengineering:sheetmetal_iron",
            T: "minecraft:redstone",
    ...
    event
        .shaped(Item.of("immersiveengineering:hemp_fabric", 1), ["XXX", "TBT", "XXX"], {
    ...
    event
        .shaped(Item.of("immersiveengineering:conveyor_basic", 8), ["   ", "TTT", "XBX"], {
    ...
    event
        .shaped(Item.of("immersiveengineering:alloybrick", 2), ["TXB", "XTB", "   "], {
            T: "#forge:sandstone",
    ...
    event
        .shaped(Item.of("immersiveengineering:cloche", 1), ["GBG", "GXG", "WCW"], {
            W: "#forge:treated_wood",
            G: "#forge:glass",
    ...
    event
        .shaped(Item.of("immersiveengineering:coil_lv", 1), ["WWW", "WLW", "WWW"], {
    ...
    event
        .shaped(Item.of("immersiveengineering:coil_mv", 1), ["WWW", "WLW", "WWW"], {
    ...
    event
        .shaped(Item.of("immersiveengineering:coil_hv", 1), ["WWW", "WLW", "WWW"], {
    ...
    event
        .shaped(
            Item.of("immersiveengineering:steel_scaffolding_standard", 6),
            ["III", " R ", "RSR"],
            {
    ...
    event
        .shaped(Item.of("immersivepetroleum:gas_generator", 1), ["PPP", "XGE", "PPP"], {
            P: "#forge:plates/iron",
    ...
    event
        .shaped(Item.of("immersiveengineering:connector_lv", 4), [" X ", "BCB", "BCB"], {
    ...
    event
        .shaped(Item.of("immersiveengineering:connector_mv", 4), [" X ", "BCB", "BCB"], {
    ...
    event
        .shaped(Item.of("immersiveengineering:connector_hv", 4), [" X ", "BCB", "BCB"], {
    ...
    event
        .shaped(Item.of("controlengineering:bus_relay", 4), [" X ", "PCP", "BBB"], {
    ...
    event
        .shaped(Item.of("controlengineering:bus_interface", 1), [" X ", "PCP", "BTB"], {
            C: "minecraft:redstone",
            B: "minecraft:terracotta",
            X: "the_vault:perfect_larimar",
            P: "#forge:plates/aluminum",
    ...
    event
        .shaped(Item.of("controlengineering:empty_tape", 1), ["WWW", "WLW", "WWW"], {
    ...
    event
        .shaped(Item.of("immersiveengineering:fluid_pipe", 8), ["WWW", " X ", "WWW"], {
