onEvent("recipes", (event) => {
    ...
    event.shaped(Item.of("thermal:energy_duct", 4), ["PXP", "KTK", "PXP"], {
    ...
    event.shaped(Item.of("thermal:fluid_duct", 4), ["PPP", "KTK", "PPP"], {
        P: "the_vault:vault_essence",
        T: "#forge:ingots/lead",
        K: "#forge:ingots/bronze",
    });

    event.shaped(Item.of("thermal:fluid_duct_windowed", 4), ["PPP", "KTK", "PPP"], {
        P: "the_vault:vault_essence",
        T: "#c:glass_blocks",
        K: "#forge:ingots/bronze",
    });

    event.shaped(Item.of("thermal:item_buffer"), ["KPK", "XTX", "KPK"], {
    ...
    event.shaped(Item.of("thermal:filter_attachment", 2), ["KTK", "XPX"], {
    ...
    event.shaped(Item.of("thermal:servo_attachment", 2), ["KTK", "XPX"], {
    ...
    event.shaped(Item.of("thermal:turbo_servo_attachment", 1), ["KTK", "XPX"], {
