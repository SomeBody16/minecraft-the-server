...
onEvent("recipes", (event) => {
    ...
    mekmachines.forEach((machine) => {
        ...
        event.shaped(Item.of(`mekanism:advanced_${machine}`), ["RCR", "IMI", "RCR"], {
        ...
        event.shaped(Item.of(`mekanism:elite_${machine}`), ["RCR", "IMI", "RCR"], {
        ...
        event.shaped(Item.of(`mekanism:ultimate_${machine}`), ["RCR", "IMI", "RCR"], {
    ...
    event.shaped(Item.of(`mekanism:basic_energy_cube`), ["RCR", "IMI", "RCR"], {
    ...
    for (let i = 0; i < basemachines.length; i++) {
        ...
        event.shaped(Item.of(`mekanism:basic_${machine}`), ["RCR", "IMI", "RCR"], {
    ...
    event
        .shaped(Item.of("mekanism:atomic_disassembler"), ["CWC", "EPE", "AOA"], {
            C: "mekanism:ultimate_control_circuit",
    ...
    event.shaped(Item.of("mekanism:steel_casing"), ["SGS", "LOL", "SGS"], {
    ...
    event.shaped(Item.of("mekanism:qio_drive_base"), ["SCS", "CPC", "SCS"], {
        S: "the_vault:chromatic_steel_ingot",
        C: "mekanism:advanced_control_circuit",
        P: "mekanism:pellet_polonium",
    });

    event.shaped(Item.of("mekanism:qio_drive_hyper_dense"), ["SCS", "DPD", "SDS"], {
    ...
    event.shaped(Item.of("mekanism:qio_drive_time_dilating"), ["SCS", "DPD", "SDS"], {
    ...
    event.shaped(Item.of("mekanism:qio_drive_supermassive"), ["SCS", "DPD", "SDS"], {
    ...
    event.shaped(Item.of("mekanism:upgrade_speed"), [" G ", "AOA", " G "], {
        G: "#forge:glass",
        A: "mekanism:alloy_infused",
        O: "#forge:ingots/osmium",
    });

    event.shaped(Item.of("mekanism:upgrade_speed", 2), [" G ", "AOA", " G "], {
        G: "#forge:glass/tinted",
        A: "mekanism:alloy_infused",
        O: "#forge:dusts/osmium",
    });

    event.shaped(Item.of("mekanism:upgrade_speed", 4), [" G ", "AOA", " G "], {
        G: "#forge:glass/tinted",
        A: "mekanism:alloy_reinforced",
        O: "#forge:dusts/osmium",
    });

    event.shaped(Item.of("mekanism:upgrade_speed", 8), [" G ", "AOA", " G "], {
        G: "#forge:glass/tinted",
        A: "mekanism:alloy_atomic",
        O: "#forge:dusts/osmium",
    });

    event.shaped(Item.of("mekanism:upgrade_energy"), [" G ", "AOA", " G "], {
        G: "#forge:glass",
        A: "mekanism:alloy_infused",
        O: "#forge:ingots/gold",
    });

    event.shaped(Item.of("mekanism:upgrade_energy", 2), [" G ", "AOA", " G "], {
        G: "#forge:glass/tinted",
        A: "mekanism:alloy_infused",
        O: "#forge:dusts/gold",
    });

    event.shaped(Item.of("mekanism:upgrade_energy", 4), [" G ", "AOA", " G "], {
        G: "#forge:glass/tinted",
        A: "mekanism:alloy_reinforced",
        O: "#forge:dusts/gold",
    });

    event.shaped(Item.of("mekanism:upgrade_energy", 8), [" G ", "AOA", " G "], {
        G: "#forge:glass/tinted",
        A: "mekanism:alloy_atomic",
        O: "#forge:dusts/gold",
    });

    event.shaped(Item.of("mekanism:upgrade_gas"), [" G ", "AOA", " G "], {
        G: "#forge:glass",
        A: "mekanism:alloy_infused",
        O: "#forge:ingots/iron",
    });

    event.shaped(Item.of("mekanism:upgrade_gas", 2), [" G ", "AOA", " G "], {
        G: "#forge:glass/tinted",
        A: "mekanism:alloy_infused",
        O: "#forge:dusts/iron",
    });

    event.shaped(Item.of("mekanism:upgrade_gas", 4), [" G ", "AOA", " G "], {
        G: "#forge:glass/tinted",
        A: "mekanism:alloy_reinforced",
        O: "#forge:dusts/iron",
    });

    event.shaped(Item.of("mekanism:upgrade_gas", 8), [" G ", "AOA", " G "], {
        G: "#forge:glass/tinted",
        A: "mekanism:alloy_atomic",
        O: "#forge:dusts/iron",
    });

    event.shaped(Item.of("mekanism:energy_tablet"), ["RGR", "ACA", "RGR"], {
        R: "#forge:dusts/redstone",
        G: "#forge:ingots/gold",
        A: "mekanism:alloy_infused",
    ...
    event.shaped(Item.of("mekanism:basic_universal_cable", 4), ["   ", "SOS", "   "], {
        S: "the_vault:chromatic_steel_ingot",
        O: "#forge:dusts/redstone",
    });

    event.shaped(Item.of("mekanism:basic_mechanical_pipe", 4), ["   ", "SOS", "   "], {
        S: "the_vault:chromatic_steel_ingot",
        O: "minecraft:bucket",
    });

    event.shaped(Item.of("mekanism:basic_thermodynamic_conductor", 4), ["   ", "SOS", "   "], {
        S: "the_vault:chromatic_steel_ingot",
        O: "#forge:ingots/copper",
    });

    event.shaped(Item.of("mekanism:basic_fluid_tank"), ["RSR", "S S", "RSR"], {
        R: "#forge:dusts/redstone",
        S: "#forge:ingots/steel",
    });

    event.shaped(Item.of("mekanism:advanced_fluid_tank"), ["RSR", "STS", "RSR"], {
        R: "mekanism:alloy_infused",
        S: "the_vault:chromatic_steel_ingot",
        T: "mekanism:basic_fluid_tank",
    });

    event.shaped(Item.of("mekanism:elite_fluid_tank"), ["RSR", "STS", "RSR"], {
        R: "mekanism:alloy_reinforced",
        S: "woldsvaults:chromatic_gold_ingot",
        T: "mekanism:advanced_fluid_tank",
    });

    event.shaped(Item.of("mekanism:ultimate_fluid_tank"), ["RSR", "STS", "RSR"], {
        R: "mekanism:alloy_atomic",
        S: "the_vault:wutodic_silver_ingot",
        T: "mekanism:elite_fluid_tank",
    });

    event.shaped(Item.of("mekanism:basic_tier_installer"), ["RCR", "IWI", "RCR"], {
        R: "#forge:dusts/redstone",
        C: "mekanism:basic_control_circuit",
        I: "the_vault:chromatic_iron_ingot",
    ...
    event.shaped(Item.of("mekanism:advanced_tier_installer"), ["RCR", "IWI", "RCR"], {
        R: "mekanism:alloy_infused",
        C: "mekanism:advanced_control_circuit",
        I: "the_vault:chromatic_steel_ingot",
        W: "the_vault:driftwood_planks",
    ...
    event.shaped(Item.of("mekanism:elite_tier_installer"), ["RCR", "IWI", "RCR"], {
        R: "mekanism:alloy_reinforced",
        C: "mekanism:elite_control_circuit",
        I: "woldsvaults:chromatic_gold_ingot",
        W: "the_vault:driftwood_planks",
    ...
    event.shaped(Item.of("mekanism:ultimate_tier_installer"), ["RCR", "IWI", "RCR"], {
        R: "mekanism:alloy_atomic",
        C: "mekanism:ultimate_control_circuit",
        I: "the_vault:gem_pog",
        W: "the_vault:driftwood_planks",
    ...
    event.shaped(Item.of("mekanismgenerators:gas_burning_generator"), ["APA", "ECE", "APA"], {
        A: "mekanism:alloy_reinforced",
    ...
    event.shaped(Item.of("mekanismgenerators:wind_generator"), [" S ", "SAS", "ECE"], {
        S: "the_vault:chromatic_steel_ingot",
        A: "mekanism:alloy_infused",
        E: "mekanism:energy_tablet",
        C: "mekanism:basic_control_circuit",
    ...
    event.shaped(Item.of("mekanismgenerators:fusion_reactor_controller"), ["CGC", "FEF", "FFF"], {
        C: "mekanism:ultimate_control_circuit",
    ...
    event.shaped(Item.of("mekanism:digital_miner"), ["AEA", "IRI", "TCT"], {
        A: "mekanism:alloy_atomic",
