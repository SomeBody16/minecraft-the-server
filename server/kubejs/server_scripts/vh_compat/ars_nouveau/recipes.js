onEvent("recipes", (event) => {
    event
        .shaped(Item.of("ars_nouveau:dull_trinket"), [" I ", "IGI", " I "], {
    ...
    event
        .shaped(Item.of("ars_nouveau:ring_of_potential"), ["III", "IGI", "III"], {
            I: "woldsvaults:chromatic_gold_nugget",
            G: "ars_nouveau:source_gem",
        })
    ...
    event
        .shaped(Item.of("ars_nouveau:blank_parchment"), ["III", "IGI", "III"], {
    ...
    event
        .shaped(Item.of("ars_nouveau:novice_spell_book"), ["UPK", "SBA", "WWW"], {
            B: "minecraft:book",
            P: "the_vault:gem_pog",
    ...
    event
        .shaped(Item.of("ars_nouveau:apprentice_spell_book"), ["BOD", "DDW", "WRR"], {
    ...
    event
        .shaped(Item.of("ars_nouveau:archmage_spell_book"), ["BOX", "DDW", "WWR"], {
    ...
    event
        .shaped(Item.of("ars_nouveau:dowsing_rod"), [" I ", "D D"], {
    ...
    event
        .shaped(Item.of("ars_nouveau:agronomic_sourcelink"), ["LGL", "DWD", "LGL"], {
    ...
    event
        .shaped(Item.of("ars_nouveau:volcanic_sourcelink"), ["LGL", "DWD", "LGL"], {
            L: "the_vault:perfect_larimar",
            D: "woldsvaults:chromatic_gold_ingot",
    ...
    event
        .shaped(Item.of("ars_nouveau:alchemical_sourcelink"), ["LGL", "DWD", "LGL"], {
            L: "the_vault:perfect_larimar",
            D: "woldsvaults:chromatic_gold_ingot",
    ...
    event
        .shaped(Item.of("ars_nouveau:mycelial_sourcelink"), ["LGL", "DWD", "LGL"], {
            L: "the_vault:perfect_larimar",
            D: "woldsvaults:chromatic_gold_ingot",
    ...
    event
        .shaped(Item.of("ars_nouveau:vitalic_sourcelink"), ["LGL", "DWD", "LGL"], {
            L: "the_vault:perfect_larimar",
            D: "woldsvaults:chromatic_gold_ingot",
    ...
    event
        .shaped(Item.of("ars_nouveau:source_jar"), ["SSS", "GLG", "SSS"], {
    ...
    event
        .shaped(Item.of("ars_nouveau:enchanting_apparatus"), ["SDS", "S S", "BBB"], {
    ...
    event
        .shaped(Item.of("ars_nouveau:scribes_table"), ["SSS", "GLG", "G G"], {
            S: "ars_nouveau:archwood_slab",
    ...
    event
        .shaped(Item.of("ars_nouveau:relay"), ["G G", "GLG", "G G"], {
    ...
    event
        .shaped(Item.of("ars_nouveau:imbuement_chamber"), ["GIG", "GLG", "GIG"], {
    ...
    event
        .shaped(Item.of("ars_nouveau:arcane_core"), ["GGG", "ILI", "GGG"], {
    ...
    event
        .shaped(Item.of("ars_nouveau:basic_spell_turret"), ["GGG", "GLI", "III"], {
            G: "ars_nouveau:source_gem",
    ...
    event
        .shapeless("ars_nouveau:runic_chalk", [
    ...
    event
        .shapeless("ars_nouveau:ritual_brazier", [
            "ars_nouveau:arcane_pedestal",
            "ars_nouveau:source_gem_block",
            "3x woldsvaults:chromatic_gold_ingot",
            "the_vault:hardened_wutodic_mass",
        ])
        .id("ars_nouveau:ritual_brazier");
    event
        .shapeless("ars_creo:starbuncle_wheel", [
            "ars_nouveau:starbuncle_charm",
            "create:water_wheel",
            "the_vault:vault_diamond_block",
        ])
