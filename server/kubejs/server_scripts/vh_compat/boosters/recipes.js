...
onEvent("recipes", (event) => {
    ...
    event.shaped(Item.of("aeinfinitybooster:infinity_card"), ["PBP", "BSB", "LLL"], {
    ...
    event.shaped(Item.of("rsinfinitybooster:infinity_card"), ["PBP", "BSB", "LLL"], {
        P: "the_vault:echo_pog",
    ...
    event.shaped(Item.of("rsinfinitybooster:dimension_card"), ["PSP", "SXS", "PSP"], {
        S: "woldsvaults:wold_star",
        P: "rsinfinitybooster:infinity_card",
        X: "the_vault:echo_pog",
    });

    event.shaped(Item.of("aeinfinitybooster:dimension_card"), ["PSP", "SXS", "PSP"], {
        S: "woldsvaults:wold_star",
