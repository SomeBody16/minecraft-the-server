...
onEvent("recipes", (event) => {
    ...
    event.shaped(Item.of("createoreexcavation:drilling_machine"), ["BSB", "MPM", "BDB"], {
    ...
    event.shaped(Item.of("createoreexcavation:extractor"), ["BSB", "MPM", "BDB"], {
    ...
    event.shaped(Item.of("createoreexcavation:drill"), ["Bb ", "bBb", " bb"], {
        B: "the_vault:chromatic_iron_block",
        b: "the_vault:chromatic_iron_ingot",
    });

    event.shaped(Item.of("createoreexcavation:diamond_drill"), ["Bb ", "bDb", " bb"], {
        B: "the_vault:vault_diamond_block",
        b: "the_vault:vault_diamond",
        D: "createoreexcavation:drill",
    });

    event.shaped(Item.of("createoreexcavation:vein_finder"), ["EA ", "RS ", "  S"], {
