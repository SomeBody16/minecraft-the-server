...
onEvent("recipes", (event) => {
    ...
    event.shaped(Item.of("sophisticatedbackpacks:crafting_upgrade"), ["ITI", "XCX", "IGI"], {
    ...
    event
        .shaped(Item.of("sophisticatedbackpacks:everlasting_upgrade"), ["XOX", "OCO", "XOX"], {
            C: "sophisticatedbackpacks:upgrade_base",
    ...
    event
        .shaped(Item.of("sophisticatedbackpacks:xp_pump_upgrade"), ["XAX", "BCB", "XAX"], {
    ...
    event
        .shaped(Item.of("sophisticatedbackpacks:tank_upgrade"), ["XOX", "OCO", "XOX"], {
            C: "sophisticatedbackpacks:upgrade_base",
            O: "#forge:glass",
    ...
    event
        .shaped(Item.of("sophisticatedbackpacks:pump_upgrade"), ["XBX", "ACD", "XBX"], {
            C: "sophisticatedbackpacks:upgrade_base",
            X: "#forge:glass",
            B: "minecraft:bucket",
    ...
    event
        .shaped(Item.of("sophisticatedbackpacks:advanced_pump_upgrade"), ["ADA", "GCG", "RRR"], {
            C: "sophisticatedbackpacks:pump_upgrade",
    ...
    event
        .shaped(Item.of("sophisticatedbackpacks:battery_upgrade"), ["XOX", "OCO", "XOX"], {
            C: "sophisticatedbackpacks:upgrade_base",
    ...
    event
        .shaped(Item.of("sophisticatedbackpacks:tool_swapper_upgrade"), ["YAY", "BCE", "XDX"], {
            C: "sophisticatedbackpacks:upgrade_base",
    ...
    event.shaped(Item.of("sophisticatedbackpacks:compacting_upgrade"), ["ITI", "XCX", "IGI"], {
        C: "sophisticatedbackpacks:upgrade_base",
        I: "the_vault:vault_diamond_block",
        T: "minecraft:piston",
    ...
    event.shaped(Item.of("sophisticatedbackpacks:smelting_upgrade"), ["ITI", "XCX", "IGI"], {
        C: "sophisticatedbackpacks:upgrade_base",
    ...
    event.shaped(Item.of("sophisticatedbackpacks:auto_smelting_upgrade"), ["ITI", "XCX", "IGI"], {
    ...
    event.shaped(Item.of("sophisticatedbackpacks:smoking_upgrade"), ["ITI", "XCX", "IGI"], {
        C: "sophisticatedbackpacks:upgrade_base",
        I: "the_vault:chromatic_iron_ingot",
        T: "minecraft:smoker",
        G: "the_vault:vault_diamond",
    ...
    event.shaped(Item.of("sophisticatedbackpacks:auto_smoking_upgrade"), ["ITI", "XCX", "IGI"], {
    ...
    event.shaped(Item.of("sophisticatedbackpacks:blasting_upgrade"), ["ITI", "XCX", "IGI"], {
        C: "sophisticatedbackpacks:upgrade_base",
        I: "the_vault:chromatic_iron_ingot",
    ...
    event.shaped(Item.of("sophisticatedbackpacks:auto_blasting_upgrade"), ["ITI", "XCX", "IGI"], {
    ...
    event
        .shaped(Item.of("sophisticatedbackpacks:inception_upgrade"), ["IXI", "ICI", "IGI"], {
    ...
    event
        .shaped(Item.of("sophisticatedbackpacks:void_upgrade"), ["SXS", "BCB", "ABA"], {
            C: "sophisticatedbackpacks:upgrade_base",
    ...
    event
        .shaped(Item.of("sophisticatedbackpacks:advanced_void_upgrade"), ["SXS", "BCB", "ALA"], {
