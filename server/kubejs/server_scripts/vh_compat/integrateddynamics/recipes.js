...
onEvent("recipes", (event) => {
    ...
    event.shaped(Item.of("integrateddynamics:wrench"), [" ML", " MM", "M  "], {
        M: "integrateddynamics:crystalized_menril_chunk",
        L: "the_vault:extraordinary_larimar",
    });

    event.shaped(Item.of("integrateddynamics:variable", 24), ["LML", "MPM", "LML"], {
    ...
    event.shaped(Item.of("integrateddynamics:logic_director"), ["CVC", "MPM", "CVC"], {
    ...
    event.shaped(Item.of("integrateddynamics:cable", 3), ["VVV", "MPM", "VVV"], {
        M: "the_vault:chromatic_steel_ingot",
        P: "the_vault:perfect_larimar",
        V: "integrateddynamics:crystalized_menril_chunk",
    });

    event.shaped(Item.of("integrateddynamics:variablestore"), ["VMV", "PCP", "VMV"], {
    ...
    event.shaped(Item.of("integrateddynamics:logic_programmer"), ["VMV", "PCP", "VMV"], {
    ...
    event.shaped(Item.of("integrateddynamics:energy_battery"), ["IMI", "ICI", "VMV"], {
    ...
    event.shaped(Item.of("integrateddynamics:coal_generator"), ["VMV", "VCV", "PEP"], {
    ...
    event.shaped(Item.of("integrateddynamics:drying_basin"), ["VMV", "C C", "VMV"], {
        V: "the_vault:driftwood_planks",
        C: "the_vault:chromatic_steel_ingot",
        M: "minecraft:black_dye",
    });

    event.shaped(Item.of("integrateddynamics:squeezer"), ["VBV", "V V", "MCM"], {
    ...
    event.shaped(Item.of("integrateddynamics:mechanical_squeezer"), ["LVL", "EME", "LPL"], {
    ...
    event.shaped(Item.of("integrateddynamics:mechanical_drying_basin"), ["LVL", "EME", "LPL"], {
        V: "the_vault:vault_diamond",
        E: "integrateddynamics:energy_battery",
    ...
    event.shaped(Item.of("integrateddynamics:part_audio_reader"), ["VPV", "PCP", "VPV"], {
        P: "minecraft:note_block",
        V: "the_vault:vault_essence",
        C: "integrateddynamics:variable_transformer_input",
    });

    event.shaped(Item.of("integrateddynamics:part_block_reader"), ["VPV", "PCP", "VPV"], {
        P: "the_vault:living_rock_block_cobble",
        V: "the_vault:vault_essence",
        C: "integrateddynamics:variable_transformer_input",
    });

    event.shaped(Item.of("integrateddynamics:part_entity_reader"), ["VPV", "PCP", "VPV"], {
    ...
    event.shaped(
        Item.of("integrateddynamics:part_extradimensional_reader"),
        ["VPV", "PCP", "VPV"],
        {
    ...
    event.shaped(Item.of("integrateddynamics:part_fluid_reader"), ["VBV", "PCP", "VBV"], {
        P: "minecraft:bucket",
    ...
    event.shaped(Item.of("integrateddynamics:part_inventory_reader"), ["VPV", "PCP", "VPV"], {
        P: "minecraft:chest",
        V: "the_vault:vault_essence",
        C: "integrateddynamics:variable_transformer_input",
    });

    event.shaped(Item.of("integrateddynamics:part_machine_reader"), ["VFV", "PCP", "VTV"], {
    ...
    event.shaped(Item.of("integrateddynamics:part_network_reader"), ["VPV", "PCP", "VPV"], {
        P: "integrateddynamics:cable",
        V: "the_vault:vault_essence",
        C: "integrateddynamics:variable_transformer_input",
    });

    event.shaped(Item.of("integrateddynamics:part_redstone_reader"), ["VPV", "BCB", "VPV"], {
    ...
    event.shaped(Item.of("integrateddynamics:part_world_reader"), ["VPV", "PCP", "VPV"], {
        P: "minecraft:obsidian",
        V: "the_vault:vault_essence",
        C: "integrateddynamics:variable_transformer_input",
    });

    event.shaped(Item.of("integrateddynamics:part_audio_writer"), ["VPV", "PCP", "VPV"], {
        P: "minecraft:note_block",
        V: "the_vault:vault_essence",
        C: "integrateddynamics:variable_transformer_output",
    });

    event.shaped(Item.of("integrateddynamics:part_entity_writer"), ["VPV", "PCP", "VPV"], {
        P: "minecraft:porkchop",
        V: "the_vault:vault_essence",
        C: "integrateddynamics:variable_transformer_output",
    });
    event.shaped(Item.of("integrateddynamics:part_effect_writer"), ["VPV", "PCP", "VPV"], {
        P: "minecraft:fire_charge",
        V: "the_vault:vault_essence",
        C: "integrateddynamics:variable_transformer_output",
    });

    event.shaped(Item.of("integrateddynamics:part_inventory_writer"), ["VPV", "PCP", "VPV"], {
        P: "minecraft:chest",
        V: "the_vault:vault_essence",
        C: "integrateddynamics:variable_transformer_output",
    });

    event.shaped(Item.of("integrateddynamics:part_machine_writer"), ["VFV", "PCP", "VTV"], {
        P: "the_vault:chromatic_iron_ingot",
        V: "the_vault:vault_essence",
        C: "integrateddynamics:variable_transformer_output",
        F: "minecraft:furnace",
    ...
    event.shaped(Item.of("integrateddynamics:part_redstone_writer"), ["VPV", "BCB", "VPV"], {
        P: "minecraft:redstone",
        B: "minecraft:redstone_block",
        V: "the_vault:vault_essence",
        C: "integrateddynamics:variable_transformer_output",
    ...
    event.shaped(Item.of("integrateddynamics:part_static_light_panel"), ["VLV", "BCR", "VLV"], {
    ...
    event.shaped(Item.of("integrateddynamics:part_display_panel"), ["VBV", "PCP", "VBV"], {
    ...
    event.shaped(
        Item.of("integrateddynamics:part_connector_mono_directional"),
        ["VOV", "PPP", "VIV"],
        {
    ...
    event
        .shaped(
            Item.of("integrateddynamics:part_connector_omni_directional", 2),
            ["VIV", "CPC", "VIV"],
            {
    ...
    event.shaped(Item.of("integratedterminals:terminal_storage_portable"), ["IVI", "PCP", "IEI"], {
    ...
    event.shaped(Item.of("integratedterminals:part_terminal_storage"), ["VSV", "OCI", "VBV"], {
    ...
    event.shaped(Item.of("integratedterminals:part_terminal_crafting_job"), ["VSV", " C ", "VBV"], {
        V: "woldsvaults:vault_essence_block",
        C: "integrateddynamics:part_display_panel",
    ...
    event.shaped(Item.of("integratedtunnels:part_interface_energy", 4), ["MMM", "BCB", "BBB"], {
        C: "integrateddynamics:energy_battery",
        B: "integrateddynamics:crystalized_menril_chunk",
        M: "the_vault:chromatic_steel_ingot",
    });

    event.shaped(Item.of("integratedtunnels:part_interface_item", 4), ["MMM", "VCV", "BBB"], {
        C: "minecraft:chest",
        B: "integrateddynamics:crystalized_menril_chunk",
        M: "the_vault:chromatic_steel_ingot",
        V: "the_vault:vault_essence",
    ...
    event.shaped(Item.of("integratedtunnels:part_interface_fluid", 4), ["MMM", "VCV", "BBB"], {
        C: "minecraft:bucket",
        B: "integrateddynamics:crystalized_menril_chunk",
        M: "the_vault:chromatic_steel_ingot",
        V: "the_vault:vault_essence",
    ...
    event.shaped(Item.of("integratedtunnels:part_player_simulator"), ["   ", "iPI", "eBE"], {
    ...
    event.shaped(Item.of("integratednbt:nbt_extractor"), ["MMM", "RCR", "BBB"], {
    ...
    event.shaped(Item.of("integratednbt:nbt_extractor_remote"), ["MMM", "RCR", "BEB"], {
        C: "integrateddynamics:logic_programmer",
        B: "integrateddynamics:crystalized_menril_block",
        M: "the_vault:chromatic_steel_ingot",
        R: "the_vault:perfect_painite",
    ...
    event.shaped(Item.of("integratedcrafting:part_interface_crafting"), ["BCB", "OMI", "BCB"], {
    ...
    event.shaped(Item.of("integratedcrafting:part_crafting_writer"), ["LBL", "TOT", "LBL"], {
        B: "the_vault:black_chromatic_steel_ingot",
