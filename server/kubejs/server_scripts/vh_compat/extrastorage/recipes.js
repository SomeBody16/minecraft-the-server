...
onEvent("recipes", (event) => {
    ...
    event.shaped(Item.of("extrastorage:advanced_exporter"), [" P ", "GEG", " P "], {
        P: "the_vault:vault_diamond",
        G: "refinedstorage:improved_processor",
        E: "refinedstorage:exporter",
    });

    event.shaped(Item.of("extrastorage:advanced_importer"), [" P ", "GEG", " P "], {
        P: "the_vault:vault_diamond",
        G: "refinedstorage:improved_processor",
        E: "refinedstorage:importer",
    });

    event.shaped(Item.of("extrastorage:neural_processor"), ["AXB", "OEO", "SOS"], {
    ...
    event.shaped(Item.of("extrastorage:storagepart_256k"), ["PIP", "CRC", "PCP"], {
    ...
    event.shaped(Item.of("extrastorage:storagepart_4096k"), ["PIP", "CRC", "PCP"], {
        P: "refinedstorage:advanced_processor",
        I: "the_vault:echoing_ingot",
    ...
    event.shaped(Item.of("extrastorage:storagepart_16384k"), ["PIP", "CRC", "PCP"], {
    ...
    event.shaped(Item.of("extrastorage:storagepart_16384k_fluid"), ["PIP", "CRC", "PCP"], {
        P: "refinedstorage:advanced_processor",
        I: "the_vault:echoing_ingot",
    ...
    event.shaped(Item.of("extrastorage:storagepart_65536k_fluid"), ["PIP", "CRC", "PCP"], {
        P: "refinedstorage:advanced_processor",
        I: "the_vault:echoing_ingot",
    ...
    event.shaped(Item.of("extrastorage:storagepart_262144k_fluid"), ["PIP", "CRC", "PCP"], {
        P: "refinedstorage:advanced_processor",
        I: "the_vault:echoing_ingot",
    ...
    event.shaped(Item.of("extrastorage:storagepart_1048576k_fluid"), ["PRP", "CRC", "PCP"], {
        P: "refinedstorage:advanced_processor",
        C: "extrastorage:storagepart_262144k_fluid",
        R: "the_vault:omega_pog",
    });

    event.shapeless("extrastorage:disk_256k", [
        "refinedstorage:storage_housing",
        "extrastorage:storagepart_256k",
    ]);
    event.shapeless("extrastorage:disk_1024k", [
        "refinedstorage:storage_housing",
        "extrastorage:storagepart_1024k",
    ]);
    event.shapeless("extrastorage:disk_4096k", [
        "refinedstorage:storage_housing",
        "extrastorage:storagepart_4096k",
    ]);
    event.shapeless("extrastorage:disk_16384k", [
        "refinedstorage:storage_housing",
        "extrastorage:storagepart_16384k",
    ]);
    event.shapeless("extrastorage:disk_16384k_fluid", [
        "refinedstorage:storage_housing",
        "extrastorage:storagepart_16384k_fluid",
    ]);
    event.shapeless("extrastorage:disk_65536k_fluid", [
        "refinedstorage:storage_housing",
        "extrastorage:storagepart_65536k_fluid",
    ]);
    event.shapeless("extrastorage:disk_262144k_fluid", [
        "refinedstorage:storage_housing",
        "extrastorage:storagepart_262144k_fluid",
    ]);
    event.shapeless("extrastorage:disk_1048576k_fluid", [
        "refinedstorage:storage_housing",
        "extrastorage:storagepart_1048576k_fluid",
    ]);

    event.shaped(Item.of("extrastorage:iron_crafter"), ["ICI", "XBX", "I I"], {
    ...
    event.shaped(Item.of("extrastorage:gold_crafter"), ["ICI", "XBX", "I I"], {
    ...
    event.shaped(Item.of("extrastorage:diamond_crafter"), ["ICI", "XBX", "I I"], {
    ...
    event.shaped(Item.of("extrastorage:netherite_crafter"), ["ICI", "XBX", "IPI"], {
