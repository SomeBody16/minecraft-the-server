onEvent("recipes", (event) => {
    ...
    Ingredient.of("@toms_storage").itemIds.forEach((id) => {
        console.log(id);
        if (!noRemoveTS.includes(id)) event.remove({ output: `${id}` });
    });

    event.shaped(Item.of("toms_storage:ts.inventory_connector"), ["WRW", "CDC", "WPW"], {
    ...
    event.shaped(Item.of("toms_storage:ts.storage_terminal"), ["WRW", "CEG", "WRW"], {
        W: "the_vault:wooden_planks",
    ...
    event.shaped(Item.of("toms_storage:ts.trim", 4), ["WCW", "CDC", "WCW"], {
        W: "the_vault:wooden_planks",
        D: "minecraft:chest",
        C: "the_vault:driftwood_planks",
    });

    event.shaped(Item.of("toms_storage:ts.inventory_cable", 6), ["WCW", "IDI", "WCW"], {
    ...
    event.shaped(Item.of("toms_storage:ts.inventory_cable_connector"), [" CW", "HBI", " DW"], {
        W: "the_vault:wooden_planks",
        D: "the_vault:vault_diamond",
    ...
    event.shaped(
        Item.of("toms_storage:ts.inventory_cable_connector_filtered"),
        [" C ", "IDI", " C "],
        {
    ...
    event.shaped(Item.of("toms_storage:ts.inventory_proxy"), ["WCW", "CDC", "WCW"], {
        W: "the_vault:wooden_planks",
        D: "minecraft:chest",
        C: "the_vault:driftwood",
    });

    event.shaped(Item.of("toms_storage:ts.crafting_terminal"), ["WXW", "CDC", "WCW"], {
    ...
    event.shaped(Item.of("toms_storage:ts.inventory_hopper_basic"), [" C ", "IDI", " H "], {
    ...
    event.shaped(Item.of("toms_storage:ts.level_emitter"), [" C ", "IDI", " H "], {
        D: "toms_storage:ts.inventory_cable",
    ...
    event.shaped(Item.of("toms_storage:ts.wireless_terminal"), ["BCB", "SDI", "BHB"], {
        D: "the_vault:gem_pog",
