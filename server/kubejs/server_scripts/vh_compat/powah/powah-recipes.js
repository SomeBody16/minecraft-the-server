onEvent("recipes", (event) => {
    ...
    // Dielectric Paste 24
    event
        .shapeless("24x powah:dielectric_paste", [
    ...
    event.shaped("8x powah:dielectric_rod_horizontal", ["DDD", "LCL", "DDD"], {
    ...
    // Dielectric Rod Horizontal 8
    event.shaped("8x powah:dielectric_rod", ["DLD", "DCD", "DLD"], {
        D: "powah:dielectric_paste",
        L: "the_vault:gem_larimar",
        C: "the_vault:chromatic_iron_ingot",
    });
    ...
    // Tiny Capacitor 8
    event.shaped("8x powah:capacitor_basic_tiny", ["MLM", "LCL", "MLM"], {
