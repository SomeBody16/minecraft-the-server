...
onEvent("recipes", (event) => {
    ...
    event.shaped(Item.of("mysticalagradditions:insanium_farmland"), ["EXE", "XVX", "EXE"], {
        V: "mysticalagriculture:supremium_farmland",
        X: "mysticalagriculture:supremium_essence",
        E: "compressium:vault_essence_block_1",
    });

    event.shaped(Item.of("mysticalagradditions:nether_star_crux"), ["EYE", "XVX", "EYE"], {
    ...
    event.shaped(Item.of("mysticalagradditions:dragon_egg_crux"), ["EYE", "XVX", "EYE"], {
        V: "woldsvaults:extraordinary_pog_prism",
    ...
    event.shaped(Item.of("mysticalagradditions:gaia_spirit_crux"), ["EYE", "XVX", "EXE"], {
        V: "woldsvaults:extraordinary_pog_prism",
    ...
    event.shaped(Item.of("mysticalagradditions:nitro_crystal_crux"), ["EYE", "XVX", "EYE"], {
        V: "woldsvaults:extraordinary_pog_prism",
