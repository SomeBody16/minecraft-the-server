...
onEvent("recipes", (event) => {
    ...
    event
        .shaped(Item.of("davespotioneering:compound_brewing_stand"), [" H ", "OSO", "DDD"], {
    ...
    event
        .shaped(Item.of("davespotioneering:reinforced_cauldron"), ["GXG", "GCG", "GYG"], {
    ...
    event
        .shaped(Item.of("davespotioneering:potioneer_gauntlet"), ["GXG", "GCG", "GXG"], {
    ...
    event
        ...
        .id("minecraft:netherite_gauntlet_smithing");
});
