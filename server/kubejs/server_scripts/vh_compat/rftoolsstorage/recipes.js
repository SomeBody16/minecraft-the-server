...
onEvent("recipes", (event) => {
    ...
    event.shaped(Item.of("rftoolsstorage:modular_storage"), ["RCR", "QFQ", "RQR"], {
    ...
    event.shaped(Item.of("rftoolsstorage:storage_module0"), [" C ", "GFG", "QRQ"], {
    ...
    event.shaped(Item.of("rftoolsstorage:storage_module1"), [" C ", "GFG", "QRQ"], {
    ...
    event.shaped(Item.of("rftoolsstorage:storage_module2"), [" C ", "GFG", "QRQ"], {
    ...
    event.shaped(Item.of("rftoolsstorage:storage_module3"), ["ICI", "GFG", "QRQ"], {
    ...
    event.shaped(Item.of("rftoolsstorage:storage_scanner"), ["RQR", "CFC", "RQR"], {
    ...
    event.shaped(Item.of("rftoolsbase:tablet"), ["RCR", "QFQ", "RQR"], {
        R: "the_vault:black_chromatic_steel_ingot",
    ...
    event.shaped(Item.of("rftoolsstorage:storage_control_module"), [" C ", "QFQ", " C "], {
        C: "the_vault:driftwood_planks",
        Q: "the_vault:vault_essence",
        F: "the_vault:chromatic_steel_ingot",
    });

    event.shaped(Item.of("rftoolsstorage:dump_module"), [" C ", "QFQ", " C "], {
        C: "#minecraft:wooden_buttons",
        Q: "the_vault:vault_essence",
        F: "the_vault:chromatic_steel_ingot",
    });

    event.shaped(Item.of("rftoolsbase:machine_infuser"), ["RCR", "QFQ", "RCR"], {
    ...
    event.shaped(Item.of("rftoolsutility:crafter1"), ["RCR", "QFQ", "RCR"], {
        R: "the_vault:black_chromatic_steel_ingot",
        C: "the_vault:gem_pog",
    ...
    event.shaped(Item.of("rftoolsutility:crafter2"), ["RVR", "QFQ", "RCR"], {
        R: "the_vault:black_chromatic_steel_ingot",
    ...
    event.shaped(Item.of("rftoolsutility:crafter3"), ["RVR", "QFQ", "RCR"], {
        R: "the_vault:black_chromatic_steel_ingot",
        C: "the_vault:echo_pog",
        Q: "minecraft:crafting_table",
    ...
    event.shaped(Item.of("rftoolsutility:screen"), ["RRR", "RFR", "CCC"], {
        R: "minecraft:tinted_glass",
        C: "the_vault:chromatic_iron_ingot",
        F: "rftoolsbase:machine_base",
    });

    event.shaped(Item.of("rftoolsutility:screen_controller"), ["RER", "CFC", "RCR"], {
    ...
    event.shaped(Item.of("rftoolsutility:matter_beamer"), ["RCR", "CFC", "RCR"], {
        R: "the_vault:vault_diamond",
        C: "quark:blaze_lantern",
        F: "rftoolsbase:machine_frame",
    });

    event.shaped(Item.of("rftoolsutility:spawner"), ["RGR", "CFB", "RPR"], {
        R: "the_vault:vault_diamond",
        C: "the_vault:gem_pog",
    ...
    event.shaped(Item.of("rftoolsutility:syringe"), ["P  ", " R ", "  B"], {
        R: "the_vault:chromatic_steel_ingot",
        B: "minecraft:glass_bottle",
        P: "the_vault:gem_painite",
    });

    event.shaped(Item.of("rftoolsutility:tank"), ["PPP", "FRF", "BBB"], {
    ...
    event.shaped(Item.of("rftoolsutility:environmental_controller"), ["RGR", "CFB", "RPR"], {
        R: "the_vault:black_chromatic_steel_ingot",
    ...
    event.shaped(Item.of("rftoolsutility:module_template"), ["RCR", "CFC", "RCR"], {
        R: "rftoolsbase:dimensionalshard",
        C: "the_vault:chromatic_iron_ingot",
        F: "rftoolsbase:infused_diamond",
    });

    event.shaped(Item.of("rftoolsutility:moduleplus_template"), ["RCR", "CFC", "RCR"], {
        R: "the_vault:perfect_larimar",
        C: "the_vault:vault_diamond",
        F: "rftoolsutility:module_template",
    });

    event.shaped(Item.of("rftoolsbase:infused_diamond"), ["RLR", "LFL", "RLR"], {
        R: "rftoolsbase:dimensionalshard",
        F: "the_vault:vault_diamond",
        L: "the_vault:gem_larimar",
    });

    event.shaped(Item.of("rftoolsbase:infused_enderpearl"), ["RLR", "LFL", "RLR"], {
        R: "rftoolsbase:dimensionalshard",
        F: "the_vault:bounty_pearl",
        L: "the_vault:gem_larimar",
    });

    event.shaped(Item.of("rftoolsutility:matter_transmitter"), ["GGG", "LFL", "RRR"], {
        R: "the_vault:chromatic_steel_ingot",
        F: "rftoolsbase:machine_frame",
    ...
    event.shaped(Item.of("rftoolsutility:matter_receiver"), ["RRR", "LFL", "GGG"], {
        R: "the_vault:chromatic_steel_ingot",
        F: "rftoolsbase:machine_frame",
        L: "the_vault:perfect_benitoite",
        G: "minecraft:ender_pearl",
    ...
    event.shaped(Item.of("rftoolsutility:dialing_device"), ["RRR", "LFL", "RRR"], {
        R: "minecraft:redstone_block",
        F: "rftoolsbase:machine_frame",
        L: "the_vault:perfect_larimar",
    });

    event.shaped(Item.of("rftoolsutility:matter_booster"), ["LRL", "RFR", "LRL"], {
        R: "minecraft:redstone_block",
        F: "rftoolsbase:machine_frame",
        L: "the_vault:chromatic_iron_ingot",
    });

    event.shaped(Item.of("rftoolsutility:charged_porter"), [" R ", "RFR", "LRL"], {
