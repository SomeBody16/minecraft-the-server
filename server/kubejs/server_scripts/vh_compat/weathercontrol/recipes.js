onEvent("recipes", (event) => {
    event
        .shaped(Item.of("weather_control:rm_casing"), ["AXA", "XBX", "AXA"], {
    ...
    event
        .shaped(Item.of("weather_control:rm_sensor"), ["AXA", "XBX", "AXA"], {
            A: "minecraft:dark_prismarine",
            X: "the_vault:black_chromatic_steel_ingot",
    ...
    event
        .shaped(Item.of("weather_control:rm_core"), ["AXA", "XBX", "ASA"], {
            A: "minecraft:dark_prismarine",
            X: "the_vault:black_chromatic_steel_ingot",
    ...
    event
        .shaped(Item.of("weather_control:rm_vent"), ["AXA", "UBU", "AXA"], {
            A: "minecraft:dark_prismarine",
            X: "the_vault:black_chromatic_steel_ingot",
    ...
    event
        .shaped(Item.of("weather_control:dw_casing"), ["AXA", "XBX", "AXA"], {
    ...
    event
        .shaped(Item.of("weather_control:dw_vent"), ["AXA", "UBU", "AXA"], {
            A: "minecraft:purpur_block",
            X: "the_vault:black_chromatic_steel_ingot",
            B: "minecraft:amethyst_block",
            U: "minecraft:iron_bars",
    ...
    event
        .shaped(Item.of("weather_control:dw_sensor"), ["AXA", "XBX", "AXA"], {
            A: "minecraft:purpur_block",
            X: "the_vault:black_chromatic_steel_ingot",
    ...
    event
        .shaped(Item.of("weather_control:dw_core"), ["AXA", "XBX", "ASA"], {
            A: "minecraft:purpur_block",
            X: "the_vault:black_chromatic_steel_ingot",
    ...
    event
        .shaped(Item.of("weather_control:mini_housing"), ["GGG", "XBX", "AAA"], {
            G: "minecraft:glass",
