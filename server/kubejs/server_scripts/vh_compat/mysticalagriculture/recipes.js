...
onEvent("recipes", (event) => {
    ...
    event.forEachRecipe({ type: "botanypots:crop", seed: "mysticalagriculture:*_seeds" }, (r) => {
        ...
        rObj.results = rObj.results.filter((result) => {
            return !/mysticalagriculture:.*_seeds/.test(result.output.item);
        });
        r.json = rObj;
    });
    ...
    event.shaped(Item.of("mysticalagriculture:inferium_essence"), ["EXE", "XVX", "EXE"], {
        V: "woldsvaults:vault_essence_block",
        X: "the_vault:vault_diamond",
        E: "the_vault:gem_larimar",
    });

    event.shaped(Item.of("mysticalagriculture:prosperity_shard"), ["EXE", "BVB", "EXE"], {
    ...
    event.shaped(Item.of("mysticalagriculture:inferium_gemstone"), ["EXE", "TVT", "EXE"], {
    ...
    event.shaped(Item.of("mysticalagriculture:prudentium_gemstone"), ["EXE", "TVT", "EXE"], {
        V: "mysticalagriculture:prosperity_gemstone",
        X: "woldsvaults:vault_essence_block",
        E: "the_vault:extraordinary_larimar",
    ...
    event.shaped(Item.of("mysticalagriculture:tertium_gemstone"), ["EXE", "TVT", "EXE"], {
        V: "mysticalagriculture:prosperity_gemstone",
        X: "woldsvaults:vault_essence_block",
        E: "the_vault:extraordinary_larimar",
    ...
    event.shaped(Item.of("mysticalagriculture:imperium_gemstone"), ["EXE", "TVT", "EXE"], {
        V: "mysticalagriculture:prosperity_gemstone",
        X: "woldsvaults:vault_essence_block",
        E: "the_vault:extraordinary_larimar",
    ...
    event.shaped(Item.of("mysticalagriculture:supremium_gemstone"), ["EXE", "TVT", "EXE"], {
        V: "mysticalagriculture:prosperity_gemstone",
        X: "woldsvaults:vault_essence_block",
        E: "the_vault:extraordinary_larimar",
    ...
    event.shaped(Item.of("mysticalagriculture:soulium_gemstone"), ["EXE", "TVT", "EXE"], {
        V: "mysticalagriculture:prosperity_gemstone",
        X: "woldsvaults:vault_essence_block",
        E: "the_vault:extraordinary_larimar",
    ...
    event.shaped(Item.of("mysticalagriculture:prosperity_ingot"), [" X ", "XVX", " X "], {
        V: "the_vault:chromatic_iron_ingot",
        X: "mysticalagriculture:prosperity_shard",
    });

    event.shaped(Item.of("mysticalagriculture:prosperity_seed_base"), ["EXE", "XVX", "EXE"], {
        V: "#forge:seeds",
        X: "mysticalagriculture:prosperity_shard",
        E: "the_vault:extraordinary_larimar",
    });

    event.shaped(Item.of("mysticalagriculture:inferium_farmland"), ["EXE", "XVX", "EXE"], {
        V: "minecraft:farmland",
        X: "mysticalagriculture:inferium_essence",
        E: "woldsvaults:vault_essence_block",
    });

    event.shaped(Item.of("mysticalagriculture:prudentium_farmland"), ["EXE", "XVX", "EXE"], {
        V: "mysticalagriculture:inferium_farmland",
        X: "mysticalagriculture:prudentium_essence",
        E: "woldsvaults:vault_essence_block",
    });

    event.shaped(Item.of("mysticalagriculture:tertium_farmland"), ["EXE", "XVX", "EXE"], {
        V: "mysticalagriculture:prudentium_farmland",
        X: "mysticalagriculture:tertium_essence",
        E: "woldsvaults:vault_essence_block",
    });

    event.shaped(Item.of("mysticalagriculture:imperium_farmland"), ["EXE", "XVX", "EXE"], {
        V: "mysticalagriculture:tertium_farmland",
        X: "mysticalagriculture:imperium_essence",
        E: "woldsvaults:vault_essence_block",
    });

    event.shaped(Item.of("mysticalagriculture:supremium_farmland"), ["EXE", "XVX", "EXE"], {
        V: "mysticalagriculture:imperium_farmland",
        X: "mysticalagriculture:supremium_essence",
        E: "woldsvaults:vault_essence_block",
    });

    event.shaped(Item.of("mysticalagriculture:inferium_furnace"), ["IEI", "IVI", "IBI"], {
        V: "minecraft:furnace",
    ...
    event.shaped(Item.of("mysticalagriculture:prudentium_furnace"), ["IEI", "IVI", "IBI"], {
    ...
    event.shaped(Item.of("mysticalagriculture:tertium_furnace"), ["IEI", "IVI", "IBI"], {
    ...
    event.shaped(Item.of("mysticalagriculture:imperium_furnace"), ["IEI", "IVI", "IBI"], {
    ...
    event.shaped(Item.of("mysticalagriculture:supremium_furnace"), ["IEI", "IVI", "IBI"], {
    ...
    event.shapeless("mysticalagriculture:soulstone", [
        "the_vault:eternal_soul",
        "minecraft:soul_sand",
        "minecraft:stone",
    ]);

    event.shaped(Item.of("mysticalagriculture:infusion_pedestal"), ["IEI", "IVI", "IVI"], {
        V: "the_vault:chromatic_steel_block",
        I: "woldsvaults:chromatic_gold_ingot",
        E: "the_vault:extraordinary_painite",
    });

    event.shaped(Item.of("mysticalagriculture:infusion_altar"), ["IEI", " V ", "BVB"], {
        V: "the_vault:chromatic_steel_block",
        I: "woldsvaults:chromatic_gold_ingot",
        E: "the_vault:extraordinary_painite",
    ...
    event.shaped(Item.of("mysticalagriculture:machine_frame"), ["EXE", "XVX", "EXE"], {
        V: "the_vault:black_chromatic_steel_block",
        X: "the_vault:extraordinary_larimar",
        E: "the_vault:chromatic_steel_ingot",
    });

    event.shaped(Item.of("mysticalagriculture:basic_reprocessor"), ["EXE", "TVT", "EXE"], {
    ...
    event.shaped(Item.of("mysticalagriculture:inferium_reprocessor"), ["IEI", "IVI", "IBI"], {
    ...
    event.shaped(Item.of("mysticalagriculture:prudentium_reprocessor"), ["IEI", "IVI", "IBI"], {
    ...
    event.shaped(Item.of("mysticalagriculture:tertium_reprocessor"), ["IEI", "IVI", "IBI"], {
    ...
    event.shaped(Item.of("mysticalagriculture:imperium_reprocessor"), ["IEI", "IVI", "IBI"], {
    ...
    event.shaped(Item.of("mysticalagriculture:supremium_reprocessor"), ["IEI", "IVI", "IBI"], {
    ...
    event.shaped(Item.of("mysticalagriculture:soulium_dust"), ["EPE", "XVX", "EPE"], {
    ...
    event.shaped(Item.of("mysticalagriculture:soulium_seed_base"), ["EXE", "XVX", "EXE"], {
        V: "mysticalagriculture:prosperity_seed_base",
        X: "mysticalagriculture:soulium_dust",
        E: "the_vault:vault_meat_block",
    });

    event.shaped(Item.of("mysticalagriculture:watering_can"), [" BI", "IVI", " I "], {
        V: "minecraft:bucket",
        I: "the_vault:chromatic_iron_ingot",
        B: "minecraft:bone_meal",
    });

    event.shaped(Item.of("woldsvaults:pogging_seed_base"), ["EXE", "XVX", "EXE"], {
        V: "mysticalagriculture:prosperity_seed_base",
        X: "the_vault:gem_pog",
        E: "the_vault:extraordinary_black_opal",
    });

    event.shaped(Item.of("woldsvaults:echoing_seed_base"), ["EXE", "XVX", "EXE"], {
        V: "woldsvaults:pogging_seed_base",
        X: "the_vault:echo_pog",
        E: "woldsvaults:pog_prism",
    });

    event.shaped(Item.of("cloudstorage:cloud", 16), ["EE ", "EE "], {
        E: "mysticalagriculture:air_essence",
    });

    event.shaped(Item.of("cloudstorage:balloon_bit", 16), [" E ", " E ", " E "], {
        E: "mysticalagriculture:air_essence",
    });

    event.shaped(Item.of("mysticalagriculture:nature_agglomeratio"), ["EXE", "XCX", "EXE"], {
        E: "the_vault:vault_diamond",
        X: "woldsvaults:vault_essence_block",
        C: "botania:world_seed",
    });

    event.shaped(Item.of("mysticalagriculture:air_agglomeratio"), ["EXE", "XCX", "EXE"], {
        E: "the_vault:vault_diamond",
        X: "woldsvaults:vault_essence_block",
        C: "botania:rune_air",
    });

    event.shaped(Item.of("mysticalagriculture:earth_agglomeratio"), ["EXE", "XCX", "EXE"], {
        E: "the_vault:vault_diamond",
        X: "woldsvaults:vault_essence_block",
        C: "botania:rune_earth",
    });

    event.shaped(Item.of("mysticalagriculture:water_agglomeratio"), ["EXE", "XCX", "EXE"], {
        E: "the_vault:vault_diamond",
        X: "woldsvaults:vault_essence_block",
        C: "botania:rune_water",
    });

    event.shaped(Item.of("mysticalagriculture:fire_agglomeratio"), ["EXE", "XCX", "EXE"], {
        E: "the_vault:vault_diamond",
        X: "woldsvaults:vault_essence_block",
        C: "botania:rune_fire",
    });
    ...
    event.shaped(Item.of("mysticalagriculture:dye_agglomeratio"), ["EXE", "XCX", "EXE"], {
        E: "the_vault:vault_diamond",
        X: "woldsvaults:vault_essence_block",
        C: "#forge:dyes",
    });

    event.shaped(Item.of("mysticalagriculture:nether_agglomeratio"), ["EXE", "XCX", "EXE"], {
        E: "the_vault:vault_diamond",
        X: "woldsvaults:vault_essence_block",
        C: "botania:rune_wrath",
    });

    event.shaped(Item.of("mysticalagriculture:end_agglomeratio"), ["EXE", "XCX", "EXE"], {
        E: "the_vault:vault_diamond",
        X: "woldsvaults:vault_essence_block",
        C: "botania:rune_envy",
    });
    ...
    event.shaped(
        Item.of("mysticalagriculture:mystical_flower_agglomeratio"),
        ["EXE", "XCX", "EXE"],
        {
            E: "the_vault:vault_diamond",
            X: "woldsvaults:vault_essence_block",
    ...
    event.shaped(Item.of("mysticalagriculture:prismarine_agglomeratio"), ["EXE", "XCX", "EXE"], {
        E: "the_vault:vault_diamond",
        X: "woldsvaults:vault_essence_block",
        C: "botania:rune_greed",
    });

    event.shaped(Item.of("mysticalagriculture:honey_agglomeratio"), ["EXE", "XCX", "EXE"], {
        E: "the_vault:vault_diamond",
        X: "woldsvaults:vault_essence_block",
        C: "botania:rune_autumn",
    });

    event.shaped(Item.of("mysticalagriculture:coral_agglomeratio"), ["EXE", "XCX", "EXE"], {
        E: "the_vault:vault_diamond",
        X: "woldsvaults:vault_essence_block",
