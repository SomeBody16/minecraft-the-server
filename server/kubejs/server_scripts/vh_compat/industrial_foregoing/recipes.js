...
onEvent("recipes", (event) => {
    ...
    event.shaped(Item.of("industrialforegoing:machine_frame_pity"), ["PRP", "RMR", "PRP"], {
        P: "the_vault:driftwood_planks",
        R: "the_vault:chromatic_steel_ingot",
        M: "the_vault:perfect_larimar",
    });

    event.shaped(Item.of("industrialforegoing:fluid_extractor"), ["PpP", "RMR", "PTP"], {
    ...
    event.shaped(Item.of("industrialforegoing:latex_processing_unit"), ["PpP", "RMr", "PTP"], {
        P: "the_vault:chromatic_steel_ingot",
    ...
    event.shaped(Item.of("industrialforegoing:dissolution_chamber"), ["PpP", "RMR", "ITI"], {
        P: "#forge:plastic",
    ...
    event.shaped(Item.of("industrialforegoing:biofuel_generator"), ["PpP", "RMR", "ITI"], {
        P: "#forge:plastic",
        p: "minecraft:furnace",
        R: "minecraft:piston",
        M: "industrialforegoing:machine_frame_pity",
    ...
    event.shaped(Item.of("industrialforegoing:iron_gear"), [" I ", "ILI", " I "], {
        I: "the_vault:chromatic_iron_ingot",
        L: "the_vault:gem_larimar",
    });

    event.shaped(Item.of("industrialforegoing:gold_gear"), [" I ", "ILI", " I "], {
        I: "woldsvaults:chromatic_gold_ingot",
        L: "the_vault:perfect_larimar",
    });

    event.shaped(Item.of("industrialforegoing:diamond_gear"), [" I ", "ILI", " I "], {
        I: "the_vault:vault_diamond",
        L: "the_vault:perfect_larimar",
    });

    event.shaped(Item.of("industrialforegoing:conveyor", 6), ["III", "PLP", "III"], {
        I: "#forge:plastic",
    ...
    event.shaped(Item.of("industrialforegoing:plant_gatherer"), ["PpP", "RMR", "ITI"], {
        P: "#forge:plastic",
    ...
    event.shaped(Item.of("industrialforegoing:plant_sower"), ["PpP", "RMR", "ITI"], {
        P: "#forge:plastic",
    ...
    event.shaped(Item.of("industrialforegoing:mob_slaughter_factory"), ["PpP", "RMR", "ITI"], {
        P: "#forge:plastic",
    ...
    event.shaped(Item.of("industrialforegoing:animal_rancher"), ["PPP", "RMR", "ITI"], {
        P: "#forge:plastic",
        R: "minecraft:shears",
        M: "industrialforegoing:machine_frame_simple",
        T: "minecraft:bucket",
    ...
    event
        .shaped(Item.of("industrialforegoing:enchantment_extractor"), ["PNP", "BMB", "ITI"], {
            P: "#forge:plastic",
    ...
    event
        .shaped(Item.of("industrialforegoing:enchantment_applicator"), ["PPP", "BMB", "IBI"], {
            P: "#forge:plastic",
    ...
    event.shaped(Item.of("industrialforegoing:mob_crusher"), ["PpP", "RMR", "ITI"], {
        P: "#forge:plastic",
    ...
    event.shaped(Item.of("industrialforegoing:hydroponic_bed"), ["PpP", "RMR", "ITI"], {
        P: "#forge:plastic",
    ...
    event.shaped(Item.of("industrialforegoing:spores_recreator"), ["PPP", "RMR", "ITI"], {
        P: "#forge:plastic",
        R: "#forge:mushrooms",
        M: "industrialforegoing:machine_frame_simple",
        T: "the_vault:chromatic_steel_block",
    ...
    event.shaped(Item.of("industrialforegoing:common_black_hole_unit"), ["PPP", "RMR", "RTR"], {
        P: "the_vault:chromatic_iron_ingot",
    ...
    event.shaped(Item.of("industrialforegoing:pity_black_hole_unit"), ["PPP", "RMR", "CTC"], {
        P: "#forge:plastic",
    ...
    event.shaped(Item.of("industrialforegoing:simple_black_hole_unit"), ["PPP", "RMR", "CTC"], {
        P: "#forge:plastic",
    ...
    event.shaped(Item.of("industrialforegoing:advanced_black_hole_unit"), ["PPP", "RMR", "CTC"], {
    ...
    event.shaped(Item.of("industrialforegoing:supreme_black_hole_unit"), ["PPP", "RMR", "CTC"], {
    ...
    event.shaped(Item.of("industrialforegoing:common_black_hole_tank"), ["PPP", "RMR", "RTR"], {
        P: "the_vault:chromatic_iron_ingot",
        R: "minecraft:bucket",
        M: "industrialforegoing:iron_gear",
        T: "industrialforegoing:machine_frame_pity",
    ...
    event.shaped(Item.of("industrialforegoing:pity_black_hole_tank"), ["PPP", "RMR", "CTC"], {
        P: "#forge:plastic",
        C: "minecraft:bucket",
        R: "the_vault:vault_essence",
        M: "minecraft:ender_pearl",
    ...
    event.shaped(Item.of("industrialforegoing:simple_black_hole_tank"), ["PbP", "RMR", "CTC"], {
        P: "#forge:plastic",
        b: "minecraft:bucket",
        C: "the_vault:chromatic_steel_block",
        R: "the_vault:extraordinary_larimar",
    ...
    event.shaped(Item.of("industrialforegoing:advanced_black_hole_tank"), ["PbP", "RMR", "CTC"], {
        P: "the_vault:extraordinary_larimar",
        b: "minecraft:bucket",
        C: "the_vault:chromatic_steel_block",
        R: "the_vault:mystical_powder",
    ...
    event.shaped(Item.of("industrialforegoing:supreme_black_hole_tank"), ["PbP", "RMR", "CTC"], {
        P: "the_vault:extraordinary_black_opal",
        b: "minecraft:bucket",
        C: "the_vault:echoing_ingot",
        R: "the_vault:echo_pog",
