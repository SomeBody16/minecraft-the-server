onEvent("recipes", (event) => {
    ...
    event
        .shaped(Item.of("psi:cad_assembly_iron"), ["   ", "III", "IL "], {
    ...
    event
        .shaped(Item.of("psi:cad_assembly_gold"), ["   ", "III", "IL "], {
    ...
    event
        .shaped(Item.of("psi:cad_assembly_psimetal"), ["   ", "III", "IL "], {
            I: "psi:psimetal",
            L: "the_vault:gem_pog",
        })
    ...
    event
        .shaped(Item.of("psi:cad_assembly_ivory_psimetal"), ["   ", "III", "IL "], {
    ...
    event
        .shaped(Item.of("psi:cad_assembly_ebony_psimetal"), ["   ", "III", "IL "], {
    ...
    event
        .shaped(Item.of("psi:cad_core_basic"), [" I ", "IDI", " I "], {
            I: "the_vault:chromatic_iron_ingot",
            D: "psi:psidust",
        })
    ...
    event
        .shaped(Item.of("psi:cad_core_overclocked"), [" I ", "IDI", " I "], {
            I: "psi:psimetal",
    ...
    event
        .shaped(Item.of("psi:cad_core_conductive"), [" I ", "IDI", " I "], {
            I: "psi:psimetal",
    ...
    event
        .shaped(Item.of("psi:cad_core_hyperclocked"), [" G ", "IDI", " G "], {
            I: "psi:psimetal",
    ...
    event
        .shaped(Item.of("psi:cad_core_radiative"), [" G ", "IDI", " G "], {
            I: "psi:psimetal",
            D: "woldsvaults:vault_essence_block",
            G: "psi:psigem",
        })
    ...
    event
        .shaped(Item.of("psi:cad_socket_basic"), ["DI ", "I  ", "   "], {
            D: "psi:psidust",
    ...
    event
        .shaped(Item.of("psi:cad_socket_signaling"), ["DI ", "I  ", "   "], {
            D: "woldsvaults:vault_essence_block",
            I: "psi:psimetal",
        })
    ...
    event
        .shaped(Item.of("psi:cad_socket_large"), ["DI ", "I  ", "   "], {
            D: "the_vault:vault_diamond",
            I: "psi:psimetal",
        })
    ...
    event
        .shaped(Item.of("psi:cad_socket_transmissive"), ["DI ", "IG ", "   "], {
            D: "woldsvaults:vault_essence_block",
            I: "psi:psimetal",
            G: "psi:psigem",
        })
    ...
    event
        .shaped(Item.of("psi:cad_socket_huge"), ["DI ", "IG ", "   "], {
            D: "the_vault:vault_diamond",
            I: "psi:psimetal",
            G: "psi:psigem",
        })
    ...
    event
        .shaped(Item.of("psi:cad_battery_basic"), [" I ", " D ", " G "], {
            I: "the_vault:chromatic_steel_ingot",
            D: "psi:psidust",
    ...
    event
        .shaped(Item.of("psi:cad_battery_extended"), [" I ", " D ", " G "], {
            I: "the_vault:chromatic_steel_ingot",
            D: "psi:psimetal",
            G: "woldsvaults:chromatic_gold_ingot",
        })
    ...
    event
        .shaped(Item.of("psi:cad_battery_ultradense"), [" I ", " D ", " G "], {
            I: "the_vault:chromatic_steel_ingot",
            D: "psi:psigem",
            G: "woldsvaults:chromatic_gold_ingot",
        })
    ...
    event
        .shaped(Item.of("psi:cad_assembler"), ["IPI", "IXI", " I "], {
            I: "the_vault:chromatic_steel_ingot",
            X: "the_vault:gem_pog",
            P: "minecraft:piston",
        })
    ...
    event
        .shaped(Item.of("psi:programmer"), ["IPI", "IXI", " I "], {
            I: "the_vault:chromatic_steel_ingot",
