onEvent("recipes", (event) => {
    ...
    event
        .shaped(Item.of("botanicalextramachinery:base_mana_pool"), ["RIR", "IPI", "BBB"], {
    ...
    event
        .shaped(Item.of("botanicalextramachinery:upgraded_mana_pool"), ["RIR", "IPI", "BBB"], {
    ...
    event
        .shaped(Item.of("botanicalextramachinery:base_runic_altar"), ["RIR", "IPI", "BBB"], {
            R: "the_vault:vault_diamond_block",
            I: "botanicalextramachinery:malachite_ingot",
            B: "botanicalextramachinery:malachite_dragonstone_block",
    ...
    event
        .shaped(Item.of("botanicalextramachinery:upgraded_runic_altar"), ["RIR", "IPI", "BBB"], {
            R: "woldsvaults:vault_ingot_block",
            I: "botanicalextramachinery:saffron_ingot",
            B: "botanicalextramachinery:saffron_dragonstone_block",
    ...
    event
        .shaped(Item.of("botanicalextramachinery:base_daisy"), ["RIR", "IPI", "BBB"], {
            R: "the_vault:vault_diamond_block",
            I: "botanicalextramachinery:malachite_ingot",
            B: "botanicalextramachinery:malachite_dragonstone_block",
    ...
    event
        .shaped(Item.of("botanicalextramachinery:upgraded_daisy"), ["RIR", "IPI", "BBB"], {
            R: "woldsvaults:vault_ingot_block",
            I: "botanicalextramachinery:saffron_ingot",
            B: "botanicalextramachinery:saffron_dragonstone_block",
    ...
    event
        .shaped(Item.of("botanicalextramachinery:base_apothecary"), ["RIR", "IPI", "BBB"], {
            R: "the_vault:vault_diamond_block",
            I: "botanicalextramachinery:malachite_ingot",
            B: "botanicalextramachinery:malachite_dragonstone_block",
    ...
    event
        .shaped(Item.of("botanicalextramachinery:upgraded_apothecary"), ["RIR", "IPI", "BBB"], {
            R: "woldsvaults:vault_ingot_block",
            I: "botanicalextramachinery:saffron_ingot",
            B: "botanicalextramachinery:saffron_dragonstone_block",
    ...
    event
        .shaped(
            Item.of("botanicalextramachinery:base_industrial_agglomeration_factory"),
            ["RIR", "IPI", "BBB"],
            {
                R: "the_vault:vault_diamond_block",
                I: "botanicalextramachinery:malachite_ingot",
    ...
    event
        .shaped(
            Item.of("botanicalextramachinery:upgraded_industrial_agglomeration_factory"),
            ["RIR", "IPI", "BBB"],
            {
                R: "woldsvaults:vault_ingot_block",
                I: "botanicalextramachinery:saffron_ingot",
    ...
    event
        .shaped(Item.of("botanicalextramachinery:base_alfheim_market"), ["RIR", "IPI", "BBB"], {
            R: "the_vault:vault_diamond_block",
            I: "botanicalextramachinery:malachite_ingot",
            B: "botanicalextramachinery:malachite_dragonstone_block",
    ...
    event
        .shaped(Item.of("botanicalextramachinery:upgraded_alfheim_market"), ["RIR", "IPI", "BBB"], {
            R: "woldsvaults:vault_ingot_block",
            I: "botanicalextramachinery:saffron_ingot",
            B: "botanicalextramachinery:saffron_dragonstone_block",
    ...
    event
        .shaped(Item.of("botanicalextramachinery:base_orechid"), ["RIR", "IPI", "BBB"], {
    ...
    event
        .shaped(Item.of("botanicalextramachinery:upgraded_orechid"), ["RIR", "IPI", "BBB"], {
            R: "woldsvaults:pog_prism",
            I: "botanicalextramachinery:saffron_ingot",
            B: "botanicalextramachinery:saffron_dragonstone_block",
    ...
    event
        .shaped(Item.of("botanicalextramachinery:advanced_orechid"), ["RIR", "IPI", "BBB"], {
    ...
    event
        .shaped(Item.of("botanicalextramachinery:ultimate_orechid"), ["RIR", "IPI", "BBB"], {
            R: "the_vault:echo_pog",
    ...
    event
        .shaped(Item.of("botanicalextramachinery:jaded_amaranthus"), ["RIR", "IFI", "BBB"], {
            R: "woldsvaults:pog_prism",
    ...
    event
        .shaped(Item.of("botanicalextramachinery:catalyst_mana_infinity"), ["BWB", "BPB", "BBB"], {
            B: "botanicalextramachinery:crimson_dragonstone_block",
