...
onEvent("recipes", (event) => {
    ...
    functionalDrawerTypes.forEach((woodType) => {
        ...
        event.shaped(Item.of(`functionalstorage:${woodType}_1`), ["GXG", "XDX", "GXG"], {
            G: "the_vault:driftwood_planks",
            X: "the_vault:chromatic_iron_ingot",
            D: `minecraft:${ingredient}`,
        });

        event.shaped(Item.of(`functionalstorage:${woodType}_2`), ["GXG", "XDX", "GXG"], {
            G: "the_vault:driftwood_planks",
            X: "the_vault:chromatic_iron_ingot",
            D: `minecraft:${woodType}_planks`,
        });

        event.shaped(Item.of(`functionalstorage:${woodType}_4`), ["GXG", "XDX", "GXG"], {
            G: "the_vault:driftwood_planks",
            X: "the_vault:chromatic_iron_ingot",
            D: `minecraft:${woodType}_planks`,
        });
    ...
    event
        .shaped(Item.of(`functionalstorage:framed_1`), ["GXG", "XDX", "GXG"], {
            G: "the_vault:driftwood_planks",
            X: "the_vault:chromatic_iron_ingot",
            D: "#minecraft:planks",
        })
    ...
    event
        .shaped(Item.of(`functionalstorage:framed_2`), ["GXG", "XDX", "GXG"], {
            G: "the_vault:driftwood_planks",
            X: "the_vault:chromatic_iron_ingot",
    ...
    event
        .shaped(Item.of(`functionalstorage:framed_4`), ["GXG", "XDX", "GXG"], {
            G: "the_vault:driftwood_planks",
            X: "the_vault:chromatic_iron_ingot",
    ...
    event
        .shaped(Item.of(`functionalstorage:compacting_drawer`), ["GXG", "IDI", "GXG"], {
    ...
    event
        .shapeless("functionalstorage:compacting_framed_drawer", [
    ...
    event
        .shapeless("functionalstorage:fluid_1", ["#functionalstorage:drawer", "minecraft:bucket"])
        .id("functionalstorage:fluid_1");
    event
        .shapeless("functionalstorage:fluid_2", ["functionalstorage:fluid_1"])
        .id("functionalstorage:fluid_2");
    event
        .shapeless("functionalstorage:fluid_4", ["functionalstorage:fluid_2"])
        .id("functionalstorage:fluid_4");

    event
        .shaped(Item.of(`functionalstorage:storage_controller`), ["GXG", "IDI", "GXG"], {
    ...
    event
        .shaped(Item.of(`functionalstorage:controller_extension`), ["BOB", "XGX", "BXB"], {
    ...
    event
        .shaped(Item.of(`functionalstorage:linking_tool`), ["GGD", "GXD", "GOG"], {
    ...
    event
        .shaped(Item.of(`functionalstorage:copper_upgrade`), ["cCc", "SDS", "cCc"], {
    ...
    event
        .shaped(Item.of(`functionalstorage:gold_upgrade`), ["ccc", "SDS", "cCc"], {
    ...
    event
        .shaped(Item.of(`functionalstorage:diamond_upgrade`), ["cCc", "SDS", "cCc"], {
    ...
    event
        .shaped(Item.of(`functionalstorage:netherite_upgrade`), ["cCc", "SDS", "cCc"], {
    ...
    event
        .shaped(Item.of(`functionalstorage:simple_compacting_drawer`), ["SSS", "SDP", "SIS"], {
    ...
    event
        .shaped(Item.of(`functionalstorage:collector_upgrade`), ["SHS", "RDR", "SHS"], {
    ...
    event
        .shaped(Item.of(`functionalstorage:puller_upgrade`), ["SHS", "SDS", "SRS"], {
            S: "the_vault:vault_diamond",
            H: "minecraft:hopper",
            R: "the_vault:vault_essence",
            D: "#functionalstorage:drawer",
    ...
    event
        .shaped(Item.of(`functionalstorage:pusher_upgrade`), ["SRS", "SDS", "SHS"], {
            S: "the_vault:vault_diamond",
            H: "minecraft:hopper",
            R: "the_vault:vault_essence",
            D: "#functionalstorage:drawer",
    ...
    event
        .shaped(Item.of(`functionalstorage:void_upgrade`), ["OOO", "BDB", "OOO"], {
    ...
    event
        .shaped(Item.of(`functionalstorage:configuration_tool`), ["GGD", "GXD", "GOG"], {
            G: "the_vault:magic_silk",
            O: "minecraft:emerald",
            D: "woldsvaults:chromatic_gold_ingot",
            X: "#functionalstorage:drawer",
    ...
    event
        .shaped(Item.of(`functionalstorage:ender_drawer`), ["OXO", "DED", "OXO"], {
            O: "minecraft:obsidian",
