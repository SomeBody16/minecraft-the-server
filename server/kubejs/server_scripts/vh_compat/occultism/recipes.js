onEvent("recipes", (event) => {
    event
        .shapeless("occultism:datura_seeds", [
    ...
    event
        .shaped(Item.of("occultism:chalk_white_impure"), ["GAE", "GAE", "GAE"], {
    ...
    event
        .shaped(Item.of("occultism:spirit_attuned_crystal"), [" C ", "CPC", " C "], {
    ...
    event
        .shaped(Item.of("occultism:divination_rod"), ["SGS", "S S", " S "], {
    ...
    event
        .shaped(Item.of("occultism:butcher_knife"), [" IS", "IS ", "S  "], {
    ...
    event
        .shaped(Item.of("occultism:iesnium_pickaxe"), ["ILI", " S ", " S "], {
    ...
    event
        .shaped(Item.of("occultism:golden_sacrificial_bowl"), ["GGG", "GBG", "GGG"], {
    ...
    event
        .shaped(Item.of("occultism:wormhole_frame"), [" G ", "GBG", " G "], {
            G: "woldsvaults:chromatic_gold_ingot",
    ...
    event
        .shaped(Item.of("occultism:storage_remote_inert"), ["GTG", "LGL", "BBB"], {
            G: "woldsvaults:chromatic_gold_ingot",
    ...
    event
        .shaped(Item.of("occultism:lens_frame"), ["SSS", "IXI", "SSS"], {
    ...
    event
        .shaped(Item.of("occultism:magic_lamp_empty"), ["PI ", "IXI", " II"], {
    ...
    event
        .shaped(Item.of("occultism:sacrificial_bowl"), ["S S", "GGG"], {
    ...
    event
        .shaped(Item.of("occultism:candle_white"), ["S", "T", "M"], {
            S: "minecraft:string",
            T: "occultism:tallow",
    ...
    event
        .shapeless("occultism:chalk_red_impure", [
            "occultism:chalk_white_impure",
            "occultism:afrit_essence",
            "minecraft:blaze_powder",
            "the_vault:perfect_painite",
        ])
        .id("occultism:crafting/chalk_red_impure");
    event
        .shapeless("occultism:chalk_gold_impure", [
            "occultism:chalk_white_impure",
            "#forge:dusts/gold",
            "minecraft:glowstone_dust",
            "woldsvaults:chromatic_gold_ingot",
        ])
        .id("occultism:crafting/chalk_gold_impure");
    event
        .shapeless("occultism:chalk_purple_impure", [
            "occultism:chalk_white_impure",
            "2x #forge:dusts/obsidian",
