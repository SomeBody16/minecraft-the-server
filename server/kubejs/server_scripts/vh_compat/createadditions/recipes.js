...
onEvent("recipes", (event) => {
    ...
    event.shaped(Item.of("createaddition:electric_motor"), ["BPB", "SCS", "XRX"], {
    ...
    event.shaped(Item.of("createaddition:alternator"), ["BPB", "SCS", "XRX"], {
        B: "the_vault:black_chromatic_steel_ingot",
        S: "create:iron_sheet",
        C: "createaddition:copper_spool",
        R: "createaddition:iron_rod",
    ...
    event.shaped(Item.of("createaddition:rolling_mill"), ["SPS", "APA", "ACA"], {
    ...
    event.shapeless("2x createaddition:connector", [
    ...
    event.shaped(Item.of("bobberdetector:bobber_detector"), ["APA", "RTR", "AMA"], {
    ...
    event.shaped(Item.of("createaddition:redstone_relay"), [" R ", "CTC", "SSS"], {
    ...
    event.shaped(Item.of("createaddition:capacitor"), ["Z", "C", "D"], {
        Z: "#forge:plates/zinc",
        C: "#forge:plates/copper",
        D: "the_vault:vault_diamond",
    });

    event.shaped(Item.of("createaddition:spool", 16), ["Z", "D", "Z"], {
        Z: "#forge:plates/iron",
        D: "the_vault:chromatic_iron_ingot",
    });

    event.shaped(Item.of("createaddition:tesla_coil", 1), ["STS", "CBC", "ZXZ"], {
        T: "create:electron_tube",
        S: "create:brass_sheet",
