...
onEvent("recipes", (event) => {
    ...
    event.shaped(Item.of("create_enchantment_industry:disenchanter"), ["XPX", "LCL", "XXX"], {
        P: "create:sand_paper",
    ...
    event.shaped(Item.of("create_enchantment_industry:printer"), ["LPL", "LCL", " X "], {
    ...
    event.recipes
        .createMixing(Fluid.of("create_enchantment_industry:hyper_experience", 10), [
