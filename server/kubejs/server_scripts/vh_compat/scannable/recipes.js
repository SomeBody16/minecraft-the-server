...
onEvent("recipes", (event) => {
    ...
    event.shaped(Item.of("scannable:scanner"), ["G G", "DCD", "LBL"], {
    ...
    event.shaped(Item.of("scannable:blank_module"), ["GGG", "DCD", "DBD"], {
    ...
    event.shaped(Item.of("scannable:range_module"), ["XRX", "RMR", "XRX"], {
        M: "scannable:blank_module",
        R: "minecraft:ender_pearl",
        X: "the_vault:echo_pog",
    });

    event.shaped(Item.of("scannable:hostile_entity_module"), ["XRX", "RMR", "XRX"], {
        M: "scannable:blank_module",
        R: "#the_vault:hostileegg",
        X: "the_vault:extraordinary_larimar",
    });

    event.shaped(Item.of("scannable:entity_module"), ["XRX", "RMR", "XRX"], {
        M: "scannable:blank_module",
        R: "minecraft:lead",
        X: "the_vault:extraordinary_larimar",
    });

    event.shaped(Item.of("scannable:friendly_entity_module"), ["XRX", "RMR", "XRX"], {
        M: "scannable:blank_module",
        R: "#the_vault:passiveegg",
        X: "the_vault:extraordinary_larimar",
    });

    event.shaped(Item.of("scannable:block_module"), ["XBX", "BMB", "XBX"], {
        M: "scannable:blank_module",
        X: "woldsvaults:pog_block",
        B: "woldsvaults:wold_star",
    });

    event.shaped(Item.of("scannable:common_ores_module"), ["XRX", "RMR", "XRX"], {
        M: "scannable:blank_module",
        R: "minecraft:coal",
        X: "the_vault:extraordinary_larimar",
    });

    event.shaped(Item.of("scannable:rare_ores_module"), ["XRX", "RMR", "XRX"], {
        M: "scannable:blank_module",
        R: "minecraft:diamond",
        X: "the_vault:extraordinary_larimar",
    });

    event.shaped(Item.of("scannable:vault_ores_module"), ["XVX", "RMR", "XBX"], {
        M: "scannable:blank_module",
    ...
    event.shaped(Item.of("scannable:vault_chests_module"), ["ABC", "XMX", "DEF"], {
        M: "scannable:blank_module",
    ...
    event.shaped(Item.of("scannable:vault_chests_module_wooden"), ["XBX", "AMA", "XBX"], {
        M: "scannable:blank_module",
    ...
    event.shaped(Item.of("scannable:vault_chests_module_ornate"), ["XBX", "AMA", "XBX"], {
        M: "scannable:blank_module",
    ...
    event.shaped(Item.of("scannable:vault_chests_module_living"), ["XBX", "AMA", "XBX"], {
        M: "scannable:blank_module",
    ...
    event.shaped(Item.of("scannable:vault_chests_module_gilded"), ["XBX", "AMA", "XBX"], {
        M: "scannable:blank_module",
    ...
    event.shaped(Item.of("scannable:vault_chests_module_raw"), ["XBX", "AMA", "XBX"], {
        M: "scannable:blank_module",
    ...
    event.shaped(Item.of("scannable:vault_chests_module_treasure"), ["XBX", "AMA", "XBX"], {
        M: "scannable:blank_module",
    ...
    event.shaped(Item.of("scannable:vault_coins_module"), ["XBX", "AMA", "XBX"], {
        M: "scannable:blank_module",
    ...
    event.shaped(Item.of("scannable:vault_spirit_module"), ["XBX", "AMA", "XBX"], {
        M: "scannable:blank_module",
    ...
    event.shaped(Item.of("scannable:vault_cake_module"), ["XBX", "AMA", "XBX"], {
        M: "scannable:blank_module",
    ...
    event.shaped(Item.of("scannable:vault_objectives_module"), ["XBX", "AMA", "XBX"], {
        M: "scannable:blank_module",
    ...
    event.shaped(Item.of("scannable:vault_doors_module"), ["XBX", "AMP", "XBX"], {
    ...
    event.shaped(Item.of("scannable:vault_treasure_doors_module"), ["XBX", "AMP", "XBX"], {
        M: "scannable:blank_module",
    ...
    event.shaped(Item.of("scannable:vault_dungeon_doors_module"), ["XBX", "AMP", "XBX"], {
        M: "scannable:blank_module",
    ...
    event.shaped(Item.of("scannable:vault_vendoors_module"), ["XBX", "AMP", "XBX"], {
        M: "scannable:blank_module",
    ...
    event.shaped(Item.of("scannable:vault_pylon_module"), ["XBX", "AMP", "XBX"], {
        M: "scannable:blank_module",
