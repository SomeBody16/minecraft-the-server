...
onEvent("recipes", (event) => {
    ...
    event.shaped(Item.of("laserio:laser_connector"), [" O ", "LCL", "III"], {
    ...
    event.shaped(Item.of("laserio:laser_node"), ["ILI", "LCL", "ILI"], {
        I: "minecraft:iron_block",
        C: "laserio:laser_connector",
        L: "the_vault:chromatic_iron_ingot",
    });

    event.shaped(Item.of("laserio:laser_wrench"), ["I I", " C ", " I "], {
        I: "the_vault:chromatic_iron_ingot",
        C: "laserio:logic_chip",
    });

    event.shaped(Item.of("laserio:card_holder"), ["I I", "SCS", "I I"], {
        I: "the_vault:chromatic_steel_ingot",
        C: "laserio:logic_chip",
        S: "minecraft:chest",
    });

    event.shaped(Item.of("laserio:card_item"), ["RLR", "QCQ", "NNN"], {
    ...
    event.shaped(Item.of("laserio:card_fluid"), ["RLR", "QCQ", "NBN"], {
        R: "minecraft:redstone_block",
        L: "the_vault:perfect_larimar",
        Q: "minecraft:quartz",
        N: "the_vault:chromatic_iron_ingot",
    ...
    event.shaped(Item.of("laserio:card_energy"), ["RLR", "QCQ", "NRN"], {
        R: "minecraft:redstone_block",
        L: "the_vault:perfect_larimar",
        Q: "minecraft:quartz",
        N: "the_vault:chromatic_iron_ingot",
    ...
    event.shaped(Item.of("laserio:card_redstone"), ["RLR", "QCQ", "NNN"], {
        R: "minecraft:redstone_block",
        L: "the_vault:perfect_larimar",
        Q: "minecraft:quartz",
        N: "the_vault:chromatic_iron_ingot",
    ...
    event.shaped(Item.of("laserio:filter_basic"), ["ILI", "LCL", "ILI"], {
        I: "the_vault:chromatic_steel_nugget",
        C: "laserio:logic_chip",
        L: "#forge:glass_panes",
    });

    event.shaped(Item.of("laserio:logic_chip_raw"), ["INI", "LCL", "INI"], {
    ...
    event.shaped(Item.of("laserio:overclocker_card"), [" I ", "LCL", "III"], {
        I: "the_vault:chromatic_steel_ingot",
        C: "laserio:logic_chip",
        L: "the_vault:perfect_larimar",
    });

    event.shaped(Item.of("laserio:overclocker_node"), [" I ", "LCL", "III"], {
