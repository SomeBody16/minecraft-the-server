onEvent("recipes", (event) => {
    ...
    event
        .shaped(Item.of("peripherals:trading_interface"), ["XIX", "IRI", "XIX"], {
    ...
    event
        .shaped(Item.of("peripherals:xp_collector"), ["XHX", "IGI", "XRX"], {
            R: "woldsvaults:pog_prism",
    ...
    event
        .shaped(Item.of("peripherals:xp_bottler"), ["XHX", "IGI", "XRX"], {
            R: "woldsvaults:pog_prism",
            I: "minecraft:lapis_block",
            X: "the_vault:chromatic_steel_ingot",
    ...
    event
        .shaped(Item.of("peripherals:loom_interface"), ["XLX", "IRI", "XIX"], {
            R: "the_vault:gem_pog",
    ...
    event
        .shaped(Item.of("peripherals:grinder"), ["XLX", "IRI", "XBX"], {
            R: "woldsvaults:pog_prism",
    ...
    event
        .shaped(Item.of("peripherals:grindstone_interface"), ["XLX", "IRI", "XIX"], {
            R: "the_vault:gem_pog",
    ...
    event
        .shaped(Item.of("peripherals:anvil_interface"), ["XLX", "IRI", "XIX"], {
            R: "the_vault:gem_pog",
    ...
    event
        .shaped(Item.of("peripherals:beehive_interface"), ["XLX", "IRI", "XIX"], {
            R: "the_vault:gem_pog",
    ...
    event
        .shaped(Item.of("peripherals:spawner_interface"), ["XLX", "IRI", "XIX"], {
            R: "woldsvaults:pog_prism",
