let removedOutputsLTL = ["littlelogistics:chunk_loader_barge", "littlelogistics:chunk_loader_car"];
onEvent("recipes", (event) => {
    ...
    event
        .shaped(Item.of("littlelogistics:rapid_hopper"), ["DHD", " R "], {
    ...
    event
        .shaped(Item.of("littlelogistics:conductors_wrench"), ["  C", " ID", "I  "], {
    ...
    event
        .shaped(Item.of("littlelogistics:barge"), [" L ", "SCS", "III"], {
            I: "the_vault:chromatic_steel_ingot",
    ...
    event
        .shaped(Item.of("littlelogistics:fishing_barge"), [" L ", "SCS", "III"], {
            I: "the_vault:chromatic_steel_ingot",
    ...
    event
        .shaped(Item.of("littlelogistics:fluid_barge"), [" L ", "SCS", "III"], {
            I: "the_vault:chromatic_steel_ingot",
            S: "minecraft:glass",
            C: "littlelogistics:barge",
            L: "the_vault:perfect_larimar",
    ...
    event
        .shaped(Item.of("littlelogistics:seater_barge"), [" L ", "SCS", "III"], {
    ...
    event
        .shaped(Item.of("littlelogistics:tug"), [" I ", "SFS", "III"], {
            I: "the_vault:chromatic_steel_ingot",
            S: "minecraft:piston",
    ...
    event
        .shaped(Item.of("littlelogistics:energy_tug"), [" I ", "SFS", "III"], {
            I: "the_vault:chromatic_steel_ingot",
            S: "minecraft:piston",
    ...
    event
        .shaped(Item.of("littlelogistics:spring", 6), ["   ", "SNS", "NSN"], {
    ...
    event
        .shaped(Item.of("littlelogistics:tug_route"), [" R ", "LTL", " R "], {
    ...
    event
        .shaped(Item.of("littlelogistics:locomotive_route"), [" R ", "LTL", " R "], {
            R: "minecraft:redstone",
            L: "the_vault:perfect_larimar",
            T: "littlelogistics:transmitter_component",
        })
    ...
    event
        .shaped(Item.of("littlelogistics:seater_car"), ["   ", "DDD", "I I"], {
    ...
    event
        .shaped(Item.of("littlelogistics:steam_locomotive"), [" I ", "PFP", "ICI"], {
            I: "the_vault:chromatic_steel_ingot",
            P: "minecraft:piston",
    ...
    event
        .shaped(Item.of("littlelogistics:energy_locomotive"), [" I ", "PFP", "ICI"], {
            I: "the_vault:chromatic_steel_ingot",
            P: "minecraft:piston",
            C: "littlelogistics:seater_car",
            F: "littlelogistics:vessel_charger",
    ...
    event
        .shaped(Item.of("littlelogistics:receiver_component", 8), [" E ", " R ", " S "], {
    ...
    event
        .shaped(Item.of("littlelogistics:transmitter_component", 4), [" E ", " R ", " S "], {
    ...
    event
        .shaped(Item.of("littlelogistics:creative_capacitor"), [" E ", "ERE", " S "], {
    ...
    event
        .shaped(Item.of("littlelogistics:vessel_charger"), [" E ", "XRX", "LRL"], {
    ...
    event
        .shaped(Item.of("littlelogistics:fluid_hopper"), ["   ", "GHG", "EGE"], {
            G: "minecraft:glass",
            H: "minecraft:hopper",
