...
onEvent("recipes", (event) => {
    ...
    event
        .shaped(Item.of("rftoolspower:blazing_agitator"), ["GGG", "DCD", "LLL"], {
    ...
    event
        .shaped(Item.of("rftoolspower:blazing_infuser"), ["GDG", "LCL", "GDG"], {
    ...
    event
        .shaped(Item.of("rftoolspower:coalgenerator"), ["GDG", "GCG", "GDG"], {
            G: "the_vault:carbon",
            D: "the_vault:perfect_larimar",
            C: "rftoolsbase:machine_frame",
        })
    ...
    event
        .shaped(Item.of("rftoolspower:power_core1"), [" D ", "GCG", " G "], {
    ...
    event
        .shaped(Item.of("rftoolspower:power_core2"), ["XDX", "GCG", "XGX"], {
            G: "minecraft:redstone",
            D: "the_vault:perfect_larimar",
            C: "woldsvaults:vault_essence_block",
    ...
    event
        .shaped(Item.of("rftoolspower:power_core3"), ["XDX", "GCG", "XGX"], {
            G: "the_vault:chromatic_steel_ingot",
    ...
    event
        .shaped(Item.of("rftoolspower:dimensionalcell"), ["XDX", "GCG", "XGX"], {
